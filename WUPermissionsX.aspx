...
<script runat="server">
    ...
    Const USER_PERMISSION_WU_IS_TSE As Integer = &H200000
    Const USER_PERMISSION_WU_IS_PILOT_USER As Integer = &H400000
    Const USER_PERMISSION_WU_IS_SALES As Integer = 16384
    ...
    Protected Sub SetTitle()
        ...
        If sTitle <> String.Empty Then
            sTitle += " - "
        End If
        Page.Header.Title = sTitle & "Western Union Permissions X"
    End Sub
        ...
        <table style="width: 100%">
            ...
            <tr id="trFindAccount" runat="server" visible="false">
                ...
                <td colspan="3">
                    ...
                    &nbsp;<asp:Button ID="btnEditPermissions" runat="server" Text="Edit permissions X"
