...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal Source As Object, ByVal E As EventArgs)
        If Not IsPostBack Then
            ...
            ManifestBarcode.Value = lCollectionKey
            ManifestBarcode.BarWidth = 0.05
            ManifestBarcode.IntegralWidth = True
            ManifestBarcode.Dpi = 300
            ManifestBarcode.ImageProviderUrl = "./DriversManifestBarcodeRenderer.aspx"
        ...
        <table style="font-size:xx-small; font-family:Verdana; width:620px">
            <tr>
                ...
                <td style="white-space:nowrap; width:200px" valign="top">
                    <barcode:Code128 runat="server" Height="50px" ID="ManifestBarcode"></barcode:Code128>
                </td>
            </tr>
            <tr>
                <td>
