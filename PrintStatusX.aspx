...
<script runat="server">
    ...
    Protected Sub BindPDFUploadView()
        Dim sSQL As String
        'sSQL = "SELECT TOP " & ddlPDFUploads.SelectedValue & " jpc.PrintType, jpu.ReadyToPrint, lp.LogisticProductKey, lp.ProductCode, lp.ProductDate, lp.ProductDescription FROM ClientData_Jupiter_PDFUploads jpu INNER JOIN LogisticProduct lp ON jpu.LogisticProductKey = lp.LogisticProductKey INNER JOIN ClientData_Jupiter_PrintCost jpc ON lp.Misc2 = jpc.[id]"
    ...
    Protected Sub lnkbtnAWB_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim sSQL As String = "SELECT ProductCode 'Product Code', ProductDate 'Product Date', ProductDescription 'Description', ItemsOut 'Qty' FROM LogisticMovement lm INNER JOIN LogisticProduct lp ON lm.LogisticProductKey = lp.LogisticProductKey WHERE ConsignmentKey = " & sConsignmentKey
        Dim dt As DataTable = ExecuteQueryToDataTable(sSQL)
...
<body>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:GridView ID="gvPDFStatus" runat="server" CellPadding="2" Font-Names="Verdana" Font-Size="XX-Small" Width="100%" OnRowDataBound="gvPDFStatus_RowDataBound" AutoGenerateColumns="False">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
