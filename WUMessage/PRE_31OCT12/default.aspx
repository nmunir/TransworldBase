        ...
        $(function () {
            $("#btn_SendMessage").click(function () {
                ...
                if (selectTopicCategory.selectedIndex == 0) {
                    ...
                    $("#selectTopicCategoryError").html("please select a topic");
        ...
        <div data-role="content">
            <div>
                <label for="selectTopicCategory">
                    Choose topic category:</label></div>
            <div>
            ...
            <div>
                <em>*</em>TSE User ID :</div>
            <div>
                <input type="text" id="txtTseUserID" value="" autofocus="autofocus" maxlength="20" data-mini="true"
                    required />
            ...
            <div>
                <em>*</em>Message :</div>
            <div>
                <textarea id="message" value="" data-theme="b" placeholder="please enter a message" data-mini="true"
