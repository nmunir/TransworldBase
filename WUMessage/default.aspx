...
<head id="Head1" runat="server">
    <title>Western Union TSE Ticket</title>
    ...
    <script type="text/javascript">
        ...
        function OnErrorAgentInfo(msg) {
            alert("Error retrieving agent data");
        }
        ...
        function OnAgentIDError(msg) {
            alert("Error verifying Agent ID " + msg);
        }
        ...
        $(function () {
            $("#btn_SendMessage").click(function () {
                ...
                var topicName = selectTopicCategory.options[selectTopicCategory.selectedIndex].text;
                if (tseUserID == '') {
                    $("#TseUserIDError").html("Enter TSE User ID and/or password");
        ...
        function OnSuccessVerifyPassword(msg) {
            if (msg == false) {
                $("#TseUserIDError").html("User ID or password not matched");
                $("#TseUserIDError").addClass("Error");
            }
            else {
                var txtTseUserID = $("#txtTseUserID");
        ...
        function OnSuccessMessage(msg) {
            if (msg > 0) {
                ...
                $("#lblMessageSent").html("Message sent");
            }
        }
...
<body>
            ...
            <div data-role="fieldcontain">
                <div class="ui-grid-a">
                    ...
                    <div class="ui-block-b">
                        <a style="text-align: right" href="http://my.transworld.eu.com/common/wuhelp/WUMobileAppHelp.htm" target="_blank">
                            help</a>
                    </div>
                </div>
                <div class="clear">
                ...
                <div>
                    <input type="text" id="text_agentname" value="" autofocus="autofocus" maxlength="10"
                        class="ui-focus" placeholder="Enter agent terminal ID" required />
                </div>
                <div>
    ...
    <div data-role="page" id="pg_Agent">
        ...
        <div data-role="content">
            ...
            <div>
                <input type="text" id="txtTseUserID" value="" autofocus="autofocus" maxlength="120"
