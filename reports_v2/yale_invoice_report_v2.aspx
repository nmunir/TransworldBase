...
<script runat="server">
    ...
    Protected Sub BindInvoiceGrid(ByVal SortField As String)
        ...
        Dim oAdapter As New SqlDataAdapter("spASPNET_Yale_GetInvoices", oConn)
    ...
    Protected Sub GetYears()
        Dim oConn As New SqlConnection(gsConn)
        Dim oDataSet As New DataSet()
        Dim oAdapter As New SqlDataAdapter("spASPNET_Yale_GetInvoiceYears", oConn)
        oAdapter.SelectCommand.CommandType = CommandType.StoredProcedure
        lblError.Text = ""
        Try
    ...
    Protected Sub GetMonths()
        Dim oConn As New SqlConnection(gsConn)
        Dim oDataSet As New DataSet()
        Dim oAdapter As New SqlDataAdapter("spASPNET_Yale_GetInvoiceMonths", oConn)
        oAdapter.SelectCommand.CommandType = CommandType.StoredProcedure
        oAdapter.SelectCommand.Parameters.Add(New SqlParameter("@Year", SqlDbType.NChar, 4))
        oAdapter.SelectCommand.Parameters("@Year").Value = psYear
        lblError.Text = ""
...
<head>
    <title>Yale Invoice Report</title>
    <link rel="stylesheet" type="text/css" href="../Reports.css" />
</head>
<body>
    <form id="YaleInvoiceReport" runat="server">
          <asp:Table id="TableHeader" runat="server" width="100%">
              <asp:TableRow>
                  ...
                  <asp:TableCell Wrap="False" width="50%">
                      <asp:Label ID="Label1" runat="server" forecolor="silver" font-size="Small" font-bold="True" font-names="Arial">Yale
