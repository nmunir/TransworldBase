    ...
    Protected Sub btnRetrieveData_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If Source.Count > 0 Then
                Dim sParams() As String = rblFileExtension.Items(rblFileExtension.SelectedIndex).Value.Split("|")
                
                Response.Clear()
                'Response.ContentType = rblFileExtension.Items(rblFileExtension.SelectedIndex).Value
                Response.ContentType = sParams(0)
                ...
                sResponseValue.Append("_" & Format(Date.Now, "ddMMMyy") & "_" & Format(Date.Now, "hhmmss"))
                'sResponseValue.Append(rblFileExtension.Items(rblFileExtension.SelectedIndex).Text)
                sResponseValue.Append(sParams(1))
...
<body>
    <form id="frmDataForCustomReports" runat="server">
        ...
        <table runat="server" id="tblRetrieveDataOptions" visible="false" width="95%">
            <tr>
                <td style="width: 50%;">
                    <asp:Label ID="lblSaveAs" runat="server" Font-Size="XX-Small" Text="Save format:" 
                        ...
                        <asp:ListItem Selected="True" Value="text/csv|.csv">Excel (comma-separated variable) </asp:ListItem>
                        <asp:ListItem Value="text/plain|.txt">Notepad (plain text)</asp:ListItem>
