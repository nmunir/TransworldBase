...
<script runat="server">
        ...
        If (CalendarInterface.Visible _
         ...
         Or _
          ...
          And IsDate(ddlToDay.SelectedItem.Text & ddlToMonth.SelectedItem.Text & ddlToYear.SelectedItem.Text)) Then
            ...
            Call ExportCSVData(ConvertDataTableToCSVString(GetData))
        Else
    ...
    Protected Function GetData() As DataTable
        ...
        Dim oAdapter As New SqlDataAdapter("spReport_DetailedBookingHistory", oConn)
        oAdapter.SelectCommand.CommandType = CommandType.StoredProcedure

        oAdapter.SelectCommand.Parameters.Add(New SqlParameter("@StartDate", SqlDbType.DateTime))
        oAdapter.SelectCommand.Parameters("@StartDate").Value = psFromDate

        oAdapter.SelectCommand.Parameters.Add(New SqlParameter("@EndDate", SqlDbType.DateTime))
        oAdapter.SelectCommand.Parameters("@EndDate").Value = pstoDate
        ...
        oAdapter.SelectCommand.Parameters.Add(New SqlParameter("@IncludeConsignments", SqlDbType.Bit))
        oAdapter.SelectCommand.Parameters("@IncludeConsignments").Value = 0

        Try
            oAdapter.Fill(oDataTable)
            GetData = oDataTable
        Catch ex As Exception
            WebMsgBox.Show("Error in GetData: " & ex.Message)
        Finally
            oConn.Close()
        End Try
    End Function
    ...
    Private Sub ExportCSVData(ByVal sCSVString As String)
        Response.Clear()
        Response.AddHeader("Content-Disposition", "attachment;filename=" & "DetailedBookingHistoryReport.csv")
...
<head>
    <title>Detailed Booking History Report</title>
    ...
    <form id="form1" runat="server">
        <table>
            <tr runat="server" visible="true">
                <td colspan="4" style="white-space:nowrap">
                  <asp:Label ID="lblPageHeading"
                             ...
                             font-size="Small"
                             font-bold="True"
                             font-names="Arial">Detailed Booking History</asp:Label><br /><br />
                </td>
            </tr>
            <tr runat="server" visible="true" id="CalendarInterface">
                ...
                <td style="width: 253px"><asp:Button ID="btnExport1" runat="server" OnClick="btnExport_Click" Text="export to excel"
            ...
            <tr runat="server" visible="false" id="DropdownInterface">
                ...
                <td style="width: 253px; height: 26px;"><asp:Button ID="btnExport2" runat="server" OnClick="btnExport_Click" Text="export to excel"
                Width="300px" Font-Names="Verdana" Font-Size="XX-Small" />
