...
<script runat="server">
    ...
    Protected Function dtGetData() As DataTable
        Dim oConn As New SqlConnection(gsConn)
        Dim oDataTable As New DataTable
        Dim oAdapter As New SqlDataAdapter("spASPNET_Report_ItemBookingHistory2", oConn)
        oAdapter.SelectCommand.CommandType = CommandType.StoredProcedure
        lblError.Text = ""
            ...
            <tr runat="server" visible="true" id="DateValidationMessages">
                ...
                <td>
                    <asp:CheckBox ID="cbShowConsignmentCost" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        Text="show consignment cost" AutoPostBack="True" OnCheckedChanged="cbShowConsignmentCost_CheckedChanged" /></td>
                <td>
                </td>
            </tr>
        </table>
