...
<script runat="server">
    ...
    Private gsSQL As String = "SELECT FirstName + ' ' + LastName + ' (' + UserId + ')' 'Owner', ProductCode 'Product Code', ISNULL(ProductDate,'') 'Value / Date', ProductDescription 'Description', CONVERT(VARCHAR(11), lp.CreatedOn, 106) 'Created On' FROM LogisticProduct lp INNER JOIN UserProfile up ON lp.StockOwnedByKey =  up.[key] WHERE lp.CustomerKey = 663 AND ISNULL(lp.StockOwnedByKey,0) > 0 AND lp.DeletedFlag = 'N' ORDER BY lp.StockOwnedByKey, lp.CreatedOn"
...
<head runat="server">
    <title>Publications By Owner</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        &nbsp;
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small" Text="Show Publications By Owner"/>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:GridView ID="gvPublications" runat="server" CellPadding="2" Font-Names="Verdana" Font-Size="XX-Small" Width="100%"/>
    </div>
    </form>
</body>
</html>
