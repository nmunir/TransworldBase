...
<script runat="server">
    ...
    Protected Sub GenerateReport()
        ...
        'sbSQL.Append("LEFT OUTER JOIN ClientData_FEXCO_SerialNumbers fsn ")
        ...
        'sbSQL.Append("( ")
        'sbSQL.Append("SELECT c.[key] FROM Consignment c INNER JOIN ClientData_FEXCO_SerialNumbers fsn ON c.[key] = fsn.ConsignmentKey ")
        'sbSQL.Append(") ")
...
<head>
    <title>Western Union Retail Services GB Lodgement Report</title>
            ...
            <tr id="Tr1" runat="server">
                <td colspan="4" style="white-space:nowrap; height: 21px;">
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Small"
                        Text="Western Union Retail Services GB Lodgement Report"></asp:Label></td>
            </tr>
