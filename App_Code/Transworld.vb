...
Namespace Transworld
    Public Class Logon
        Public Function GetUserInfo(ByVal sUserId As String) As UserInfo
            ...
            Dim oCmd As SqlCommand = New SqlCommand("spASPNET_UserProfile_ValidateId6", oConn)
            ...
            Dim paramCustomerCreatedOn As SqlParameter = New SqlParameter("@CustomerCreatedOn", SqlDbType.SmallDateTime)
            paramCustomerCreatedOn.Direction = ParameterDirection.Output
            oCmd.Parameters.Add(paramCustomerCreatedOn)
            ...
            If Not IsDBNull(paramCustomerCreatedOn.Value) Then
                oUserInfo.CustomerCreatedOn = CDate(paramCustomerCreatedOn.Value)
            Else
                oUserInfo.CustomerCreatedOn = DateTime.MinValue
            End If
    ...
    Public Class UserInfo
        ...
        Public CustomerCreatedOn As DateTime
    End Class
