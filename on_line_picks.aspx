   ...
   <script type="text/javascript">
       function ShowBox() {
           if (confirm("do you want to go ahead ?") == true) {
               //do something
               window.location.href = "on_line_picks.aspx";
               return true;
           }
           else {
               return false;
...
<script runat="server">
    ...
    Sub mymsgbox()
        ...
        msgbox.Show(count, "Hello World", Windows.Forms.MessageBoxButtons.OK, _
    ...
    ' SERVICE LEVELS
    ' -1 = NOT DEFINED
    ' -2 = -STD- ie non-UK destination including Channel Islands and Northern Ireland
    ' -3 = –STD-UK ie UK destinations excluding Channel Islands and Northern Ireland
    ' -4 = RD-SAVER    
    
    Const SERVICE_LEVEL_NEG1_UNDEFINED As Int32 = -1
    Const SERVICE_LEVEL_NEG2_STD_NON_UK_INCL_UK_NON_MAINLAND As Int32 = -2
    Const SERVICE_LEVEL_NEG3_STD_UK_MAINLAND_ONLY As Int32 = -3
    Const SERVICE_LEVEL_NEG4_RD_SAVER As Int32 = -4
    Const SERVICE_LEVEL_NEG5_ECONOMY As Int32 = -5
    Const SERVICE_LEVEL_NEG6_ECON_UK As Int32 = -6
    ...
    Const PER_CUSTOMER_CONFIGURATION_31_OPUS As Int32 = 31
    Const PER_CUSTOMER_CONFIGURATION_32_JAMESHARDIE As Int32 = 32
    Const PER_CUSTOMER_CONFIGURATION_33_SENSE As Int32 = 33
    ...
    Const COUNTRY_CODE_FRANCE As Integer = 73
    ...
    Const JAMES_HARDIE_COVER_LETTER_UK As Int32 = 89422
    Const JAMES_HARDIE_COVER_LETTER_GERMANY As Int32 = 89423
    Const JAMES_HARDIE_COVER_LETTER_FRANCE As Int32 = 89424
    ...
    Dim gsCnorCompany As String
    Dim gsCnorAddr1 As String
    Dim gsCnorAddr2 As String
    Dim gsCnorAddr3 As String
    Dim gsCnorTown As String
    Dim gsCnorState As String
    Dim gsCnorPostCode As String
    Dim gsCnorCountryName As String
    Dim gsCnorCountryKey As String
    Dim gsCnorCtcName As String
    Dim gsCnorCtcTel As String
    Dim gsCnorCtcEmail As String
    ...
    Protected Sub Page_Load(ByVal Source As Object, ByVal E As EventArgs)
        ...
        gsBasketCountName = "SB_BasketCount" & gnMode.ToString
        ...
        If Not IsPostBack Then
            ...
            Call PerCustomerConfiguration()                                                       ''NEED TO LOOK AT
            ...
            If Not gnMode = MODE_JUPITER_POD Then
                ...
                Else
                    Dim sCookieBasket = Request.Cookies("SprintBasket")("SB_LocalBasket") & String.Empty
                    ...
                    If sCookieBasket <> String.Empty AndAlso BasketIsEmpty() AndAlso gnMode = MODE_JUPITER_STOCK Then
                        Call FillBasketFromCookie()
                    End If
                End If
            End If
            If IsJamesHardie() Then
                Call FixJamesHardieMonthlyLimits()
            End If
        End If
    ...
    Protected Function BasketIsEmpty() As Boolean
        BasketIsEmpty = False
        If gdtBasket Is Nothing Then
            BasketIsEmpty = True
        ElseIf gdtBasket.Rows.Count = 0 Then
            BasketIsEmpty = True
        End If
    End Function

    Protected Sub CreateLocalBasketIfNull()
        Call GetBasketFromSession()
    End Sub
        
    Protected Sub CreateLocalBasket()
        ...
        gdtBasket.Columns.Add(New DataColumn("QtyAvailable", GetType(Integer)))
        gdtBasket.Columns.Add(New DataColumn("QtyToPick", GetType(Integer)))
    ...
    Protected Sub SaveBasketToSession()
        Dim dtSessionBasket As DataTable = New DataTable()
        dtSessionBasket.Columns.Add(New DataColumn("ProductKey", GetType(String)))
        dtSessionBasket.Columns.Add(New DataColumn("QtyAvailable", GetType(Integer)))
        dtSessionBasket.Columns.Add(New DataColumn("QtyToPick", GetType(Integer)))
        dtSessionBasket.Columns.Add(New DataColumn("Authorised", GetType(String)))
        
        Dim drSessionRow As DataRow
        For Each drLocalRow As DataRow In gdtBasket.Rows
            drSessionRow = dtSessionBasket.NewRow()
            drSessionRow("ProductKey") = drLocalRow("ProductKey").ToString
            drSessionRow("QtyAvailable") = drLocalRow("QtyAvailable")
            drSessionRow("QtyToPick") = drLocalRow("QtyToPick")
            drSessionRow("Authorised") = drLocalRow("Authorised")
            dtSessionBasket.Rows.Add(drSessionRow)
        Next
        
        If gnMode = MODE_JUPITER_STOCK Then
            Session("SB_LocalBasket") = gdtBasket
            Session("SB_SessionBasket") = dtSessionBasket
        Else
            Session("SB_LocalBasketJupiter") = gdtBasket
            Session("SB_SessionBasketJupiter") = dtSessionBasket
        End If
        If Not gnMode = MODE_JUPITER_POD Then
    ...
    Protected Sub GetBasketFromSession()
        If IsNothing(gdtBasket) Then
            Call CreateLocalBasket()
            If gnMode = MODE_JUPITER_STOCK Then
                Call BuildLocalBasket("SB_SessionBasket")
            Else
                Call BuildLocalBasket("SB_SessionBasketJupiter")
            End If
        End If
    End Sub
    
    Protected Sub BuildLocalBasket(ByVal sBasketName As String)
        Dim drLocalBasketEntry As DataRow
        Dim drSessionBasketEntry As DataRow
        Dim sSQL As String
        If Not IsNothing(Session(sBasketName)) Then
            Dim dtSessionBasket As DataTable = Session(sBasketName)
            For Each drSessionBasketEntry In dtSessionBasket.Rows
                Dim nLogisticProductKey As Int32 = drSessionBasketEntry("ProductKey")
                sSQL = "SELECT ProductCode, ISNULL(ProductDate, '') ProductDate, ISNULL(ProductDescription, '') 'ProductDescription', ISNULL(LanguageID, '') 'LanguageID', ISNULL(ItemsPerBox, 0) 'ItemsPerBox', UnitWeightGrams, UnitValue, ISNULL(UnitValue2, 0) 'UnitValue2', PDFFileName, OriginalImage, ThumbNailImage, ISNULL(Notes, '') 'Notes', ISNULL(CalendarManaged, 0) 'CalendarManaged' FROM LogisticProduct WHERE LogisticProductKey = " & nLogisticProductKey ' NOTE: at present missing out QtyAvailable, QtyToPick, Authorised)
                drLocalBasketEntry = gdtBasket.NewRow()
                
                Dim drLogisticProduct As DataRow = ExecuteQueryToDataTable(sSQL).Rows(0)
                drLocalBasketEntry("ProductCode") = drLogisticProduct("ProductCode")
                drLocalBasketEntry("ProductDate") = drLogisticProduct("ProductDate")
                drLocalBasketEntry("Description") = drLogisticProduct("ProductDescription")
                drLocalBasketEntry("LanguageID") = drLogisticProduct("LanguageID")
                drLocalBasketEntry("BoxQty") = drLogisticProduct("ItemsPerBox")
                drLocalBasketEntry("UnitWeightGrams") = drLogisticProduct("UnitWeightGrams")
                drLocalBasketEntry("UnitValue") = drLogisticProduct("UnitValue")
                drLocalBasketEntry("UnitValue2") = drLogisticProduct("UnitValue2")
                drLocalBasketEntry("PDFFileName") = drLogisticProduct("PDFFileName")
                drLocalBasketEntry("OriginalImage") = drLogisticProduct("OriginalImage")
                drLocalBasketEntry("ThumbNailImage") = drLogisticProduct("ThumbNailImage")
                drLocalBasketEntry("Notes") = drLogisticProduct("Notes")
                drLocalBasketEntry("CalendarManaged") = drLogisticProduct("CalendarManaged")

                drLocalBasketEntry("ProductKey") = drSessionBasketEntry("ProductKey")
                drLocalBasketEntry("QtyAvailable") = drSessionBasketEntry("QtyAvailable")
                drLocalBasketEntry("QtyToPick") = drSessionBasketEntry("QtyToPick")
                drLocalBasketEntry("Authorised") = drSessionBasketEntry("Authorised")
                gdtBasket.Rows.Add(drLocalBasketEntry)
            Next
        End If
    End Sub
    ...
    Protected Function IsOpus() As Boolean
        Dim nCustomerKey As Integer = CInt(Session("CustomerKey"))
        IsOpus = IIf(gbSiteTypeDefined, gsSiteType = "opus", nCustomerKey = CUSTOMER_OPUS)
    End Function
    ...
    Protected Function IsJamesHardieFR() As Boolean
        Dim nCustomerKey As Integer = CInt(Session("CustomerKey"))
        IsJamesHardieFR = IIf(gbSiteTypeDefined, gsSiteType = "hardfr", nCustomerKey = CUSTOMER_HARDFR)
    End Function

    Protected Function IsSense() As Boolean
        Dim nCustomerKey As Integer = CInt(Session("CustomerKey"))
        IsSense = IIf(gbSiteTypeDefined, gsSiteType = "sense", nCustomerKey = CUSTOMER_SENSE)
    End Function
    
    'Protected Sub PopulateJamesHardieServiceLevelDropdownUK()
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Clear()
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Add(New ListItem("Express", "EXPRESS"))
    '    ddlPerCustomerConfiguration32ServiceLevel.SelectedIndex = 0
    'End Sub
    
    'Protected Sub PopulateJamesHardieServiceLevelDropdownNonUK()
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Clear()
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Add(New ListItem("- please select -", 0))
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Add(New ListItem("Economy", "ECONOMY"))
    '    ddlPerCustomerConfiguration32ServiceLevel.Items.Add(New ListItem("Express", "EXPRESS"))
    '    ddlPerCustomerConfiguration32ServiceLevel.SelectedIndex = 0
    'End Sub
    ...
    Protected Function IsNotStruttWUHysterYaleCABHardie() As Boolean
        IsNotStruttWUHysterYaleCABHardie = Not (IsWURS() Or IsStrutt() Or IsHysterOrYale() Or IsCAB() Or IsJamesHardie())
    End Function
    ...
    Protected Sub PerCustomerConfiguration()
        ...
        If IsOpus() Then
            plPerCustomerConfiguration = PER_CUSTOMER_CONFIGURATION_31_OPUS
            Call HideStandardCheckoutCustRefArea()
            Call HideStandardConfirmationCustRefArea()
            trPerCustomerConfiguration31Checkout1.Visible = True
            trPerCustomerConfiguration31Confirmation1.Visible = True
            lblLegendCnee.Text = "Name:"
            lblLegendCneeCtcName.ForeColor = lblLegendCneeAddr2.ForeColor
            rfvCneeCtcName.Enabled = False
            rfvCneeCtcName.Visible = False
            Exit Sub
        End If

        If IsJamesHardie() Then
            plPerCustomerConfiguration = PER_CUSTOMER_CONFIGURATION_32_JAMESHARDIE
            Call HideStandardCheckoutCustRefArea()
            Call HideStandardConfirmationCustRefArea()
            psServiceLevel = "ECONOMY"
            trPerCustomerConfiguration32Checkout1.Visible = True
            trPerCustomerConfiguration32Checkout2.Visible = True
            trPerCustomerConfiguration32Confirmation1.Visible = True
            
            If IsJamesHardieFR() Then
                lblLegendDeliveryAddress.Text = "Address de Livraison"
                lblLegendCneeAddr1.Text = "Addresse 1:"
                lblLegendCneeAddr2.Text = "Addresse 2:"
                lblLegendCneeAddr3.Text = "Addresse 3:"
                lblLegendCountry.Text = "Pays:"
                lblLegendCity.Text = "Ville:"
                lblLegendCnee.Text = "Entreprise:"
                lblLegendRegion.Text = "Pays / Région:"
                lblLegendSpecialInstructionsCheckout.Text = "Instruction spéciales:"
                lblLegendPackingNoteText.Text = "Note emballage:"
                lnkbtnCneeCountryFR.Visible = True
            End If
            'lnkbtnDisplayModeChange.Visible = False
            'chk_QuickMode.Visible = False
            'aQuickModeHelp.Visible = False
            Exit Sub
        End If
        
        If IsSense() Then
            Call GetCustomerServiceLevels()
            plPerCustomerConfiguration = PER_CUSTOMER_CONFIGURATION_33_SENSE
            trStandardCheckoutCustRef2.Visible = False
            trStandardConfirmationCustRef2.Visible = False
            trPerCustomerConfiguration33Confirmation1.Visible = True
            Exit Sub
        End If
    ...
    Protected Sub GetCustomerServiceLevels()
        If IsHysterOrYale() Then
        ...
        ElseIf IsSense() Then
            ddlPerCustomerConfiguration33Confirmation1ServiceLevel.Items.Clear()
            ddlPerCustomerConfiguration33Confirmation1ServiceLevel.Items.Add(New ListItem("- please select -", 0))
            ddlPerCustomerConfiguration33Confirmation1ServiceLevel.Items.Add(New ListItem("ECONOMY MAIL", 1))
            ddlPerCustomerConfiguration33Confirmation1ServiceLevel.Items.Add(New ListItem("PRIORITY MAIL", 2))
        Else
            Dim oConn As New SqlConnection(gsConn)
    ...
    Protected Sub btnShowByCategory_click(ByVal sender As Object, ByVal e As System.EventArgs)
        If pnlBasket.Visible Or pnlClassicBasket.Visible Then
            'Call SaveBasketQuantities()
            If Not ValidBasket() Then
                Exit Sub
            End If
        End If
    ...
    Protected Sub ShowCategoriesPanel()                                                 '' NEED TO LOOK 
        lblSubCategoryHeadingA.Text = "Sub Category"
        lblSubCategoryHeadingB.Visible = False
    ...
    Protected Sub lnkbtnShowSubCategories_click(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Else
            lblCategoryHeader.Text = " Category selection: " & psCategory
            Call BindProductGridDispatcher("ProductCode", CATEGORY_MODE_1_CATEGORY)
            Call ShowProductList()
        End If
    End Sub
    ...
    Protected Sub lnkbtnShowSubSubCategories_click(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Else
            ...
            Call BindProductGridDispatcher("ProductCode", CATEGORY_MODE_2_CATEGORIES)
            Call ShowProductList()
        End If
    End Sub
    ...
    Protected Sub lnkbtnShowProductsByCategory_click(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        End If
        Call BindProductGridDispatcher("ProductCode", pnCategoryMode)
        Call ShowProductList()
    End Sub
    ...
    Protected Sub SaveBasketQuantities()
        Dim nRowCount As Int32
        If pnlBasket.Visible Then
            nRowCount = gvBasket.Items.Count
        ElseIf pnlClassicBasket.Visible Then
            nRowCount = dgrdBasket.Items.Count
        Else
            ' ??????
        End If
        If nRowCount > 0 Then
    ...
    Protected Sub PreConfirmOrder()
        If IsJamesHardie() Then
            Dim nJamesHardieCoverLetterRadioButtonChecked As Int32 = IsJamesHardieCoverLetterRadioButtonChecked()
            Select Case nJamesHardieCoverLetterRadioButtonChecked
                Case JAMES_HARDIE_COVER_LETTER_UK
                    If Not BasketContainsJamesHardieCoverLetter(JAMES_HARDIE_COVER_LETTER_UK) Then
                        Call AddItemToBasket(JAMES_HARDIE_COVER_LETTER_UK, bIsFromCookieBasket:=False)
                    End If
                Case JAMES_HARDIE_COVER_LETTER_GERMANY
                    If Not BasketContainsJamesHardieCoverLetter(JAMES_HARDIE_COVER_LETTER_GERMANY) Then
                        Call AddItemToBasket(JAMES_HARDIE_COVER_LETTER_GERMANY, bIsFromCookieBasket:=False)
                    End If
                Case JAMES_HARDIE_COVER_LETTER_FRANCE
                    If Not BasketContainsJamesHardieCoverLetter(JAMES_HARDIE_COVER_LETTER_FRANCE) Then
                        Call AddItemToBasket(JAMES_HARDIE_COVER_LETTER_FRANCE, bIsFromCookieBasket:=False)
                    End If
            End Select
        End If
        Call ConfirmOrder()
    ...
    Protected Sub ConfirmOrder()
        ...
        If IsSense() Then
            ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedIndex = 0
        End If
    ...
    Protected Sub BindProductGridDispatcher(ByVal SortField As String, nCategoryCount As Int32)
        pnMostRecentCategoryCount = nCategoryCount
        If psDisplayMode <> DISPLAY_MODE_CATEGORY Then
            Call BindProductGrid(SortField, bUseCategories:=False, nCategoryCount:=nCategoryCount)
        Else
            Call BindProductGrid(SortField, bUseCategories:=True, nCategoryCount:=nCategoryCount)
        End If
    End Sub
    ...
    Protected Sub BindProductGrid(ByVal SortField As String, ByVal bUseCategories As Boolean, nCategoryCount As Int32)
        Dim oConn As New SqlConnection(gsConn)
        Dim oDataTable As New DataTable
        ...
        Dim sProc As String = "spASPNET_Product_GetProducts12"
        If IsJupiter() Then
            If gnMode = MODE_JUPITER_POD Then
                sProc = "spASPNET_Product_GetProductsJupiterPOD2"
            Else
                sProc = "spASPNET_Product_GetProductsJupiterStock2"
            End If
        End If
        ...
        oAdapter.SelectCommand.Parameters("@CategoryMode").Value = nCategoryCount
    ...
    Protected Sub BindBasketGrid(ByVal SortField As String)
        ...
        If IsShowingRichView() Then
            If Not IsNothing(gdtBasket) Then
                ...
                gdvBasketView.Sort = "ProductCode ASC," & SortField '
    ...
    Protected Sub gvProductList_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs)
        ...
        Call BindProductGridDispatcher("ProductCode", pnMostRecentCategoryCount)
    End Sub
    ...
    Protected Sub SortProductColumns(ByVal Source As Object, ByVal E As DataGridSortCommandEventArgs)
        Call BindProductGridDispatcher(E.SortExpression, pnCategoryMode)
    End Sub
    
    Protected Sub GetCategories()
        Dim oConn As New SqlConnection(gsConn)
        Dim oDataSet As New DataSet()
        Dim sProc As String = "spASPNET_Product_GetCategoriesForUser"                       '' PRODUCT STORED PROCEDURE  NEED TO LOOK
        If IsJupiter() Then
            If gnMode = MODE_JUPITER_POD Then
    ...
    Protected Sub AddAssocProdToBasket(ByVal sProductKey As String)
        ...
        Try
            ...
            oDataReader = oCmd.ExecuteReader()
            oDataReader.Read()
            Call CreateLocalBasketIfNull() ' probably don't need this since the basket must exist to get here
            Call GetBasketFromSession()
            gdvBasketView = New DataView(gdtBasket)
            gdvBasketView.RowFilter = "ProductKey='" & sProductKey & "'"
            If gdvBasketView.Count = 0 Then
    ...
    Protected Sub GetCountries()
        ...
        If IsHysterOrYale() Then
            For i = 1 To ddlCneeCountry.Items.Count - 1
                If ddlCneeCountry.Items(i).Text = "UGANDA" Then
                    Dim li As ListItem = ddlCneeCountry.Items(i)
                    ddlCneeCountry.Items.RemoveAt(i)
                    ddlCneeCountry.Items.Add(li)
                End If
                If (ddlCneeCountry.Items(i).Text = "UK" Or ddlCneeCountry.Items(i).Text = "U.K.") And Not ddlCneeCountry.Items(i).Text.Contains("(N. IRELAND)") Then
                    ddlCneeCountry.Items(i).Text = " U.K. (EXCL N.IRELAND)"
                End If
            Next
        End If
    End Sub
    ...
    Protected Function ValidBasket() As Boolean
        ...
        End If
        If ValidBasket AndAlso IsJamesHardie() Then
            Dim dblJamesHardieMonthlyOrderRemainingAllowance As Double = GetJamesHardieMonthlyOrderRemainingAllowance()
            If dblJamesHardieMonthlyOrderRemainingAllowance >= 0 Then
                Dim dblBasketTotalValue As Double = 0
                For Each drBasketEntry As DataRow In gdtBasket.Rows
                    dblBasketTotalValue += drBasketEntry("UnitValue") * drBasketEntry("QtyToPick")
                Next
                If dblBasketTotalValue > dblJamesHardieMonthlyOrderRemainingAllowance Then
                    lblBasketMessage1.Text = "The total value of your basket (£" & Format(dblBasketTotalValue, "##,##0.00") & ") exceeds your remaining monthly allowance of £" & Format(dblJamesHardieMonthlyOrderRemainingAllowance, "##,##0.00") & ". Please adjust your basket."
                    lblBasketMessage2.Text = lblBasketMessage1.Text
                    ValidBasket = False
                End If
            End If
    ...
    Protected Function ValidateClassicBasket() As Boolean
        ...
        For Each dgi In dgrdBasket.Items
            ...
            If IsNumeric(sQtyToPick) And IsNumeric(sQtyAvailable) Then
                If (CLng(sQtyToPick) > CLng(sQtyAvailable)) And Not (bCalendarManaged) Then
                    bValid = False
                    lblError.Text = "Row " & i & " has a pick quantity that exceeds the available quantity"
                ElseIf CLng(sQtyToPick) = 0 And Not (bCalendarManaged) Then
                    bValid = False
    ...
    Function sBuildConsignorAddress() As String
        ...
        sConsignor = gsCnorCompany & CR
        sConsignor &= gsCnorAddr1 & CR
        If gsCnorAddr2 <> "" Then
            If gsCnorAddr3 <> "" Then
                sConsignor &= gsCnorAddr2 & " " & gsCnorAddr3 & CR
            Else
                sConsignor &= gsCnorAddr2 & CR
            End If
        End If
        If gsCnorState <> "" Then
            If gsCnorPostCode <> "" Then
                sConsignor &= gsCnorTown & " " & gsCnorState & " " & gsCnorPostCode & CR
            Else
                sConsignor &= gsCnorTown & " " & gsCnorState & CR
            End If
        Else
            If gsCnorPostCode <> "" Then
                sConsignor &= gsCnorTown & " " & gsCnorPostCode & CR
            Else
                sConsignor &= gsCnorTown & CR
            End If
        End If
        sConsignor &= gsCnorCountryName & CR
        If gsCnorCtcTel <> "" Then
            sConsignor &= gsCnorCtcName & " " & gsCnorCtcTel & CR
        Else
            sConsignor &= gsCnorCtcName & CR
        End If
        If gsCnorCtcEmail <> "" Then
            sConsignor &= gsCnorCtcEmail
        End If
    ...
    Protected Sub SummariseBooking()
        ...
        If Not IsNothing(gdtBasket) Then
            ...
            If plPerCustomerConfiguration = PER_CUSTOMER_CONFIGURATION_6_CIMA Then
                lblPerCustomerConfiguration6ConfirmationDepartment.Text = Session("SB_BookingRef1")
                lblPerCustomerConfiguration6ConfirmationCostCentre.Text = Session("SB_BookingRef2")
                lblPerCustomerConfiguration6ConfirmationReference.Text = Session("SB_BookingRef3")
            End If
    ...
    Protected Sub CaptureBookingInstructions()
        ...
        If IsJamesHardie() Then
            Session("SB_BookingRef1") = ddlPerCustomerConfiguration32CustomerType.SelectedValue
            Session("SB_BookingRef2") = String.Empty
            Session("SB_BookingRef3") = tbPerCustomerConfiguration32OtherDetail.Text
            Session("SB_BookingRef4") = String.Empty
            If ddlPerCustomerConfiguration32CustomerType.SelectedValue <> "OTHER" Then
                lblPerCustomerConfiguration32ConfirmationCustomerType.Text = ddlPerCustomerConfiguration32CustomerType.SelectedValue
            Else
                lblPerCustomerConfiguration32ConfirmationCustomerType.Text = "OTHER: " & tbPerCustomerConfiguration32OtherDetail.Text
            End If
        End If
    End Sub
    ...
    Protected Sub ResetFields()
        ...
        ddlPerCustomerConfiguration31ServiceLevel.SelectedIndex = -1
        'If Session("CustomerKey") = CUSTOMER_JAMESHARDIE Then
        '    Call PopulateJamesHardieServiceLevelDropdownNonUK()
        'End If
        
        If IsJamesHardie() Then
            ddlPerCustomerConfiguration32CustomerType.SelectedIndex = -1
            lblLegend32JamesHardieOtherDetail.Visible = False
            tbPerCustomerConfiguration32OtherDetail.Visible = False
            tbPerCustomerConfiguration32OtherDetail.Text = String.Empty
            rbJamesHardieIncludeCoverLetterUK.Checked = False
            rbJamesHardieIncludeCoverLetterUK.Enabled = True
            rbJamesHardieIncludeCoverLetterGermany.Checked = False
            rbJamesHardieIncludeCoverLetterGermany.Enabled = True
            rbJamesHardieIncludeCoverLetterFrance.Checked = False
            rbJamesHardieIncludeCoverLetterFrance.Enabled = True
        End If
    End Sub
    
    Protected Sub ClearOrderSessionVariables()
        Session(gsBasketCountName) = Nothing
        Session("SB_LocalBasket") = Nothing
        Session("SB_SessionBasket") = Nothing
        Session("SB_LocalBasketJupiter") = Nothing
        Session("SB_SessionBasketJupiter") = Nothing
    ...
    Protected Sub btn_CheckOut_click(ByVal s As Object, ByVal e As System.EventArgs)
        ...
        If ValidBasket() Then
            ...
            End If
            If IsJamesHardie() Then
                If Not BasketContainsJamesHardieCoverLetter() Then
                    rbJamesHardieIncludeCoverLetterUK.Enabled = True
                    rbJamesHardieIncludeCoverLetterGermany.Enabled = True
                    rbJamesHardieIncludeCoverLetterFrance.Enabled = True
                ElseIf Not IsJamesHardieCoverLetterRadioButtonChecked() Then
                    rbJamesHardieIncludeCoverLetterUK.Enabled = False
                    rbJamesHardieIncludeCoverLetterGermany.Enabled = False
                    rbJamesHardieIncludeCoverLetterFrance.Enabled = False
                End If
            End If
        Else
    ...
    Protected Function GetServiceLevelCode() As Int32
        GetServiceLevelCode = SERVICE_LEVEL_NEG1_UNDEFINED
        Dim sServiceLevel As String = psServiceLevel.Trim.ToLower
        Select Case Session("CustomerKey")
            Case CUSTOMER_JAMESHARDIE
                If sServiceLevel = "economy" Then
                    GetServiceLevelCode = SERVICE_LEVEL_NEG4_RD_SAVER
                Else
                    If ddlCneeCountry.SelectedValue = COUNTRY_CODE_UK Then
                        GetServiceLevelCode = SERVICE_LEVEL_NEG3_STD_UK_MAINLAND_ONLY
                    Else
                        GetServiceLevelCode = SERVICE_LEVEL_NEG2_STD_NON_UK_INCL_UK_NON_MAINLAND
                    End If
                End If
            Case CUSTOMER_HYSTER, CUSTOMER_YALE
                If sServiceLevel = "standard" Then
                    GetServiceLevelCode = SERVICE_LEVEL_NEG5_ECONOMY
                Else
                    If ddlCneeCountry.SelectedValue = COUNTRY_CODE_UK Then
                        GetServiceLevelCode = SERVICE_LEVEL_NEG3_STD_UK_MAINLAND_ONLY
                    Else
            ...
            Case CUSTOMER_CAB
                If sServiceLevel = "standard" Then
                    GetServiceLevelCode = SERVICE_LEVEL_NEG6_ECON_UK
                Else
                    If ddlCneeCountry.SelectedValue = COUNTRY_CODE_UK Then
                        GetServiceLevelCode = SERVICE_LEVEL_NEG3_STD_UK_MAINLAND_ONLY
                    Else
    ...
    '    param10.Value = GetServiceLevelCode()
    ...
    '            oTrans.Commit()
    '            If Session("CustomerKey") = CUSTOMER_HYSTER Or Session("CustomerKey") = CUSTOMER_YALE Then
    '                Call RecordHysterYaleUnitPrices(lConsignmentKey)
    '            End If
    ...
    Protected Sub RecordHysterYaleUnitPrices(ByVal nConsignmentKey As Int32)
        Call ExecuteQueryToDataTable("INSERT INTO HysterYaleUnitPrices (lm.ConsignmentKey, lm.LogisticProductKey, lp.UnitPrice) SELECT lm.ConsignmentKey, lm.LogisticProductKey, lp.UnitValue FROM LogisticMovement lm INNER JOIN LogisticProduct lp ON lm.LogisticProductKey = lp.LogisticProductKey WHERE lm.ConsignmentKey = " & nConsignmentKey)
    End Sub
    ...
    Protected Function PlaceOrderOnHold(ByVal dicOrderItems As Dictionary(Of Integer, Integer)) As Integer
        ...
        Dim param13 As SqlParameter = New SqlParameter("@CnorName", SqlDbType.NVarChar, 50)
        param13.Value = gsCnorCompany
        oCmdAddBooking.Parameters.Add(param13)

        Dim param14 As SqlParameter = New SqlParameter("@CnorAddr1", SqlDbType.NVarChar, 50)
        param14.Value = gsCnorAddr1
        oCmdAddBooking.Parameters.Add(param14)

        Dim param15 As SqlParameter = New SqlParameter("@CnorAddr2", SqlDbType.NVarChar, 50)
        param15.Value = gsCnorAddr2
        oCmdAddBooking.Parameters.Add(param15)

        Dim param16 As SqlParameter = New SqlParameter("@CnorAddr3", SqlDbType.NVarChar, 50)
        param16.Value = gsCnorAddr3
        oCmdAddBooking.Parameters.Add(param16)

        Dim param17 As SqlParameter = New SqlParameter("@CnorTown", SqlDbType.NVarChar, 50)
        param17.Value = gsCnorTown
        oCmdAddBooking.Parameters.Add(param17)

        Dim param18 As SqlParameter = New SqlParameter("@CnorState", SqlDbType.NVarChar, 50)
        param18.Value = gsCnorState
        oCmdAddBooking.Parameters.Add(param18)

        Dim param19 As SqlParameter = New SqlParameter("@CnorPostCode", SqlDbType.NVarChar, 50)
        param19.Value = gsCnorPostCode
        oCmdAddBooking.Parameters.Add(param19)

        Dim param20 As SqlParameter = New SqlParameter("@CnorCountryKey", SqlDbType.Int, 4)
        param20.Value = CLng(gsCnorCountryKey)
        oCmdAddBooking.Parameters.Add(param20)

        Dim param21 As SqlParameter = New SqlParameter("@CnorCtcName", SqlDbType.NVarChar, 50)
        param21.Value = gsCnorCtcName
        oCmdAddBooking.Parameters.Add(param21)

        Dim param22 As SqlParameter = New SqlParameter("@CnorTel", SqlDbType.NVarChar, 50)
        param22.Value = gsCnorCtcTel
        oCmdAddBooking.Parameters.Add(param22)

        Dim param23 As SqlParameter = New SqlParameter("@CnorEmail", SqlDbType.NVarChar, 50)
        param23.Value = gsCnorCtcEmail
        oCmdAddBooking.Parameters.Add(param23)
            ...
            Try
                    ...
                    If BasketView.Count > 0 Then
                        ...
                        If plPerCustomerConfiguration = PER_CUSTOMER_CONFIGURATION_8_MAN Then
                            If tbPerCustomerConfiguration8MDSOrderRef.Text.Trim.Length > 0 Then
                                ...
                                oCmdUpdateMSDOrderRef.Parameters.Add(paramConsignmentKey)
                ...
                If Not BookingFailed Then
                    ...
                    If IsHysterOrYale() Then
                        ...
                        Call RecordHysterYaleUnitPrices(plConsignmentKey)
                    End If
                    ...
                    If IsJamesHardie() Then
                        Call JamesHardieAddOrderValueToMonthTally()
                    End If
                Else
                    oTrans.Rollback("AddBooking")
                End If
    ...
    Protected Sub JamesHardieAddOrderValueToMonthTally()
        Dim dblBasketTotalValue As Double = 0
        For Each drBasketEntry As DataRow In gdtBasket.Rows
            dblBasketTotalValue += drBasketEntry("UnitValue") * drBasketEntry("QtyToPick")
        Next
        Dim sSQL As String = "UPDATE ClientData_JamesHardie_MonthOrderValue SET MonthOrderValue = 0 WHERE UserKey = " & Session("UserKey") & " AND DATEPART(m, LastUpdatedOn) <> DATEPART(m, GETDATE()) UPDATE ClientData_JamesHardie_MonthOrderValue SET MonthOrderValue = MonthOrderValue + " & dblBasketTotalValue & ", LastUpdatedOn = GETDATE() WHERE UserKey = " & Session("UserKey") & " IF @@ROWCOUNT = 0 INSERT INTO ClientData_JamesHardie_MonthOrderValue (UserKey, MonthOrderValue, OverrideCheck, LastUpdatedOn) VALUES (" & Session("UserKey") & ", " & dblBasketTotalValue & ", 0, GETDATE())"
        Call ExecuteQueryToDataTable(sSQL)
        'Call ExecuteQueryToDataTable("UPDATE ClientData_JamesHardie_MonthOrderValue SET MonthOrderValue = 0 WHERE UserKey = " & Session("UserKey") & " AND DATEPART(m, LastUpdatedOn) <> DATEPART(m, GETDATE()) UPDATE ClientData_JamesHardie_MonthOrderValue SET MonthOrderValue = MonthOrderValue + " & dblBasketTotalValue & ", LastUpdatedOn = GETDATE() WHERE UserKey = " & Session("UserKey") & " IF @@ROWCOUNT = 0 INSERT INTO ClientData_JamesHardie_MonthOrderValue (UserKey, MonthOrderValue, OverrideCheck, LastUpdatedOn) VALUES (" & Session("UserKey") & ", " & dblBasketTotalValue & ", 0, GETDATE())")
    End Sub
    ...
    Protected Function bSetAuthorisationInfoVisibility(ByVal DataItem As Object) As String
        ...
        If (pbOrderAuthorisation Or pbProductAuthorisation) Or pbCalendarManagement Then
            If pbOrderAuthorisation Or pbProductAuthorisation Then
                Dim au As AuthorisationInfo
                au = GetProductAuthorisationInfo(DataBinder.Eval(DataItem, "LogisticProductKey"))
                If au.bIsAuthorisable Then
    ...
    Protected Sub ddlPerCustomerConfiguration31ServiceLevel_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ddl As DropDownList = sender
        psServiceLevel = ddlPerCustomerConfiguration31ServiceLevel.SelectedItem.Text
        lblPerCustomerConfiguration31ConfirmationServiceLevel.Text = ddlPerCustomerConfiguration31ServiceLevel.SelectedItem.Text
    End Sub
    ...
    Protected Sub CreateSprintBasketCookie()
        ...
        c.Values.Add("SB_LocalBasket", String.Empty)
        c.Expires = DateTime.Now.AddDays(365)
        Response.Cookies.Add(c)
    End Sub
    ...
    Protected Sub FillBasketFromCookie()
        ...
        Dim sBasket() As String = (Request.Cookies("SprintBasket")("SB_LocalBasket") & "").Split("|")
    ...
    Protected Sub UpdateSprintBasketCookie()
        ...
        End If
        Dim c As HttpCookie = New HttpCookie("SprintBasket")
        c.Values.Add("SB_LocalBasket", sbEncodedBasket.ToString)
    ...
    Protected Sub CMSelectEventAddress()
        ...
        Else
            ...
            tbCMEventAddress1.Text = Trim(objAddress.OrganisationName & " " & objAddress.Line1)
            tbCMEventAddress2.Text = Trim(objAddress.Line2 & " " & objAddress.Line3)
    ...
    Protected Sub CMSelectCollectionAddress()
        ...
        Else
            objAddress = objAddressResults.Results(0)
            'txtCneeName.Text = objAddress.OrganisationName
            tbCMCollectionAddress1.Text = Trim(objAddress.OrganisationName & " " & objAddress.Line1)
            tbCMCollectionAddress2.Text = Trim(objAddress.Line2 & " " & objAddress.Line3)
    ...
    Property pnMostRecentCategoryCount() As Integer
        Get
            Dim o As Object = ViewState("SB_MostRecentCategoryCount")
            If o Is Nothing Then
                Return 0
            End If
            Return CInt(o)
        End Get
        Set(ByVal Value As Integer)
            ViewState("SB_MostRecentCategoryCount") = Value
        End Set
    End Property
    ...
    Property pbBasketContainsWURSCriticalProducts() As Boolean
        Get
            Dim o As Object = ViewState("SB_LocalBasketContainsWURSCriticalProducts")
            If o Is Nothing Then
                Return False
            End If
            Return CBool(o)
        End Get
        Set(ByVal Value As Boolean)
            ViewState("SB_LocalBasketContainsWURSCriticalProducts") = Value
        End Set
    End Property
    ...
    Property pdblBasketTotalValue() As Double
        Get
            Dim o As Object = ViewState("SB_LocalBasketTotalValue")
            If o Is Nothing Then
                Return 0.0
            End If
            Return CDbl(o)
        ...
        Set(ByVal Value As Double)
            ViewState("SB_LocalBasketTotalValue") = Value
        End Set
    End Property
    
    Property plBasketWeightGrams() As Long
        Get
            Dim o As Object = ViewState("SB_LocalBasketWeightGrams")
            If o Is Nothing Then
                Return 0
            End If
            Return CLng(o)
        End Get
        Set(ByVal Value As Long)
            ViewState("SB_LocalBasketWeightGrams") = Value
        End Set
    End Property
    ...
    Protected Sub lnkbtnCneeCountryUK_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        For i As Integer = 1 To ddlCneeCountry.Items.Count - 1
            If ddlCneeCountry.Items(i).Value = COUNTRY_CODE_UK Then
                ddlCneeCountry.SelectedIndex = i
                Call SetCountry(ddlCneeCountry.SelectedValue, "")
                txtCneeName.Focus()
                Exit For
        ...
        'If Session("CustomerKey") = CUSTOMER_JAMESHARDIE Then
        '    Call PopulateJamesHardieServiceLevelDropdownUK()
        '    psServiceLevel = ddlPerCustomerConfiguration32ServiceLevel.SelectedItem.Text
        '    lblPerCustomerConfiguration32ConfirmationServiceLevel.Text = ddlPerCustomerConfiguration32ServiceLevel.SelectedItem.Text
        'End If
    ...
    Protected Sub SetCountryOther()
        ...
        If IsJamesHardieFR() Then
            lblLegendPostcodeZipcode.Text = "Code Postal:"
        End If
    End Sub
    ...
    Protected Sub ddlPerCustomerConfiguration32CustomerType_SelectedIndexChanged(sender As Object, e As System.EventArgs)
        Dim ddl As DropDownList = sender
        If ddl.SelectedValue = "OTHER" Then
            lblLegend32JamesHardieOtherDetail.Visible = True
            tbPerCustomerConfiguration32OtherDetail.Visible = True
            tbPerCustomerConfiguration32OtherDetail.Focus()
        Else
            lblLegend32JamesHardieOtherDetail.Visible = False
            tbPerCustomerConfiguration32OtherDetail.Visible = False
        End If
    ...
    Protected Sub rbJamesHardieIncludeCoverLetter_CheckedChanged(sender As Object, e As System.EventArgs)
        Dim rb As RadioButton = sender
        Dim nAvailableQuantity As Int32 = 0
        If rb.Text.Contains("UK") Then
            nAvailableQuantity = GetAvailableQty(JAMES_HARDIE_COVER_LETTER_UK)
        ElseIf rb.Text.Contains("Germany") Then
            nAvailableQuantity = GetAvailableQty(JAMES_HARDIE_COVER_LETTER_GERMANY)
        Else
            nAvailableQuantity = GetAvailableQty(JAMES_HARDIE_COVER_LETTER_FRANCE)
        End If
        If nAvailableQuantity = 0 Then
            WebMsgBox.Show("The requested cover letter is out of stock.")
            rbJamesHardieIncludeCoverLetterUK.Checked = False
            rbJamesHardieIncludeCoverLetterGermany.Checked = False
            rbJamesHardieIncludeCoverLetterFrance.Checked = False
        End If
    ...
    Protected Function BasketContainsJamesHardieCoverLetter() As Int32
        BasketContainsJamesHardieCoverLetter = 0
        Call GetBasketFromSession()
        For Each dr As DataRow In gdtBasket.Rows
            Dim nLogisticProductKey As Int32 = dr("ProductKey")
            If nLogisticProductKey = JAMES_HARDIE_COVER_LETTER_UK Or nLogisticProductKey = JAMES_HARDIE_COVER_LETTER_GERMANY Or nLogisticProductKey = JAMES_HARDIE_COVER_LETTER_FRANCE Then
                BasketContainsJamesHardieCoverLetter = nLogisticProductKey
                Exit For
            End If
        Next
    End Function

    Protected Function BasketContainsJamesHardieCoverLetter(nLogisticProductKey As Int32) As Boolean
        BasketContainsJamesHardieCoverLetter = False
        Call GetBasketFromSession()
        For Each dr As DataRow In gdtBasket.Rows
            If nLogisticProductKey = dr("ProductKey") Then
                BasketContainsJamesHardieCoverLetter = True
                Exit For
            End If
        Next
    End Function

    Private Function GetAvailableQty(ByVal nLogisticProductKey As Int32) As Int32
    ...
    Private Function IsJamesHardieCoverLetterRadioButtonChecked() As Int32
        IsJamesHardieCoverLetterRadioButtonChecked = 0
        If rbJamesHardieIncludeCoverLetterUK.Checked Then
            IsJamesHardieCoverLetterRadioButtonChecked = JAMES_HARDIE_COVER_LETTER_UK
        ElseIf rbJamesHardieIncludeCoverLetterGermany.Checked Then
            IsJamesHardieCoverLetterRadioButtonChecked = JAMES_HARDIE_COVER_LETTER_GERMANY
        ElseIf rbJamesHardieIncludeCoverLetterFrance.Checked Then
            IsJamesHardieCoverLetterRadioButtonChecked = JAMES_HARDIE_COVER_LETTER_FRANCE
        End If
    End Function

    Protected Sub ddlPerCustomerConfiguration33Confirmation1ServiceLevel_SelectedIndexChanged(sender As Object, e As System.EventArgs)
        If ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedValue > 0 Then
            psServiceLevel = ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedItem.Text
            Session("SB_SpecialInstructions") = Session("SB_SpecialInstructions").ToString.Replace("SVC: ECONOMY MAIL. ", "").Replace("SVC: PRIORITY MAIL. ", "")
            If ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedValue = 1 Then
                Session("SB_SpecialInstructions") = "SVC: ECONOMY MAIL. " & Session("SB_SpecialInstructions")
            ElseIf ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedValue = 2 Then
                Session("SB_SpecialInstructions") = "SVC: PRIORITY MAIL. " & Session("SB_SpecialInstructions")
            End If
            psServiceLevel = ddlPerCustomerConfiguration33Confirmation1ServiceLevel.SelectedItem.Text
        End If
    End Sub
    
    Protected Sub lnkbtnCneeCountryFR_Click(sender As Object, e As System.EventArgs)
        For i As Integer = 1 To ddlCneeCountry.Items.Count - 1
            If ddlCneeCountry.Items(i).Value = COUNTRY_CODE_FRANCE Then
                ddlCneeCountry.SelectedIndex = i
                Call SetCountry(ddlCneeCountry.SelectedValue, "")
                txtCneeName.Focus()
                Exit For
    ...
    Protected Sub FixJamesHardieMonthlyLimits()
        Call ExecuteQueryToDataTable("INSERT INTO ClientData_JamesHardie_MonthOrderValue (UserKey, MonthOrderValue, LastUpdatedOn, OverrideCheck) SELECT [key], 0, GETDATE(), 0 FROM UserProfile WHERE CustomerKey IN (837, 849) AND Status = 'Active' AND DeletedFlag = 0 AND NOT [key] IN (SELECT UserKey FROM ClientData_JamesHardie_MonthOrderValue)")
    End Sub
...
<body>
            ...
            <td align="right" valign="middle" style="white-space: nowrap">
                ...
                <span id="spanQuickModeCheckBox" visible="true" runat="server">
                    <asp:CheckBox ID="chk_QuickMode" runat="server" Text="quick mode" ForeColor="Gray"
                        ...
                        AutoPostBack="true"></asp:CheckBox>&nbsp;&nbsp;<a id="aQuickModeHelp" runat="server" onmouseover="return escape('<b>quick mode</b> allows you to select several products without returning to your basket between each selection')"
                    ...
                    <ItemTemplate>
                        ...
                        <table width="100%" style="font-family: Verdana; font-size: xx-small; color: Gray"
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <asp:Label ID="lblLegendQtyPerBox" runat="server" Visible="<%# IsNotStruttWUHysterYaleCABHardie() %>"
                                        ForeColor="Gray">Qty/box:</asp:Label>
                                </td>
                                <td valign="top">
                                    <asp:Label ID="Label56" runat="server" Visible="<%# IsNotStruttWUHysterYaleCABHardie() %>"
    ...
    <asp:Panel ID="pnlBasket" runat="server" Visible="False" Width="100%">
        <asp:Table ID="tabBasketHeader" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
            ...
            <asp:TableRow>
                ...
                <br />
                <br />
                For orders to multiple destinations proceed to checkout, select the destination list 
                from the dropdown box, then specify the quantity required for each destination.</span>
                ...
                </asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow></asp:Table><asp:DataGrid ID="gvBasket" runat="server" Width="100%" Font-Names="Verdana" Font-Size="XX-Small"
                        ...
                        <table width="100%" style="font-family: Verdana; font-size: xx-small; color: Gray"
                            ...
                            <tr>
                                <td style="width: 5%">
                                    ...
                                    &nbsp; </td><td style="width: 12%; white-space: nowrap" valign="top">
                                    <asp:Label ID="Label7" runat="server" ForeColor="Gray">Product Code:</asp:Label></td><td style="width: 20%; white-space: nowrap" valign="top">
                                    <asp:Label ID="Label8" runat="server" ForeColor="Red"><%# DataBinder.Eval(Container.DataItem,"ProductCode") %></asp:Label></td><td style="width: 12%; white-space: nowrap" valign="top">
                                    <asp:Label ID="Label9" runat="server" ForeColor="Gray">Version/Date:</asp:Label></td><td style="width: 20%; white-space: nowrap" valign="top">
                                    <asp:Label ID="Label12" runat="server" ForeColor="Red"><%# DataBinder.Eval(Container.DataItem,"ProductDate") %></asp:Label></td><td style="width: 16%; white-space: nowrap" align="right" valign="top">
                                    <asp:Label ID="Label13" runat="server" ForeColor="Gray">Qty Available:</asp:Label>&nbsp; <asp:Label ID="lblQtyAvailable" runat="server" ForeColor="Navy"><%#Format(DataBinder.Eval(Container.DataItem, "QtyAvailable"), "#,##0")%></asp:Label><asp:HiddenField
                                ...
                                <td style="white-space: nowrap">
                                    <asp:Label ID="Label18" runat="server" Visible="<%# IsNotStruttWUHysterYaleCABHardie() %>"
                                        ForeColor="Gray">Qty/box:</asp:Label></td><td style="white-space: nowrap">
                                    <asp:Label ID="Label19" runat="server" Visible="<%# IsNotStruttWUHysterYaleCABHardie() %>"
                                        ForeColor="Red"><%# DataBinder.Eval(Container.DataItem,"BoxQty") %></asp:Label></td><td style="white-space: nowrap" align="right" valign="top">
                                </td>
                                <td rowspan="4">
                                    &nbsp; </td></tr><tr>
                                <td>
                                    <asp:Label ID="Label16" runat="server" ForeColor="Gray">Description:</asp:Label></td><td colspan="3" rowspan="3" valign="top">
                                    <asp:Label ID="Label25" runat="server" ForeColor="Navy"><%# DataBinder.Eval(Container.DataItem,"Description") %></asp:Label></td><td>
                                    &nbsp; </td></tr><tr>
                                <td>
                                    &nbsp; </td><td>
                                    &nbsp; </td></tr><tr>
                                <td style="white-space: nowrap">
                                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Remove" ForeColor="Blue"
                                        ToolTip="remove this item from your order">remove item</asp:LinkButton></td><td style="white-space: nowrap" align="right">
                                    <asp:Label ID="lblLegendOrderQuantity" runat="server" Font-Size="XX-Small">Order Quantity:</asp:Label><asp:TextBox
                                        ...
                                        Text='<%# DataBinder.Eval(Container.DataItem,"QtyToPick") %>' Width="50px"></asp:TextBox></td></tr><tr>
                                <td>
                                    &nbsp; </td><td colspan="6" valign="top">
                                    <hr />
                                </td>
                                <td>
                                    &nbsp; </td></tr></table></ItemTemplate></asp:TemplateColumn></Columns></asp:DataGrid><table id="tabBasketFooter" style="font-family: Verdana; font-size: xx-small;
            width: 100%">
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="lblBasketMessage2" runat="server" BackColor="#F9D938" ForeColor="Navy"
                        Font-Names="Verdana" Font-Size="X-Small"></asp:Label></td><td>
                </td>
            </tr>
        </table>
        <asp:Panel ID="pnlAssociatedProducts" runat="server" Visible="False" Width="100%">
            <asp:Table ID="tabAssocProdsHeader" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                ...
                <asp:TableRow ID="TableRow1" runat="server">
                    <asp:TableCell ID="TableCell1" Width="5%" runat="server"></asp:TableCell><asp:TableCell
                        ID="TableCell2" Width="90%" runat="server">
                        <br />
                        <asp:Label ID="Label1" runat="server" BackColor="#F9D938" Font-Size="X-Small" ForeColor="Navy"> Associated Products - please review before proceeding </asp:Label>
                        <br />
                        <br />
                    <asp:Label ID="Label2" runat="server" Font-Size="XX-Small">One or more items in your basket has had another product(s) associated with
                    ...
                    </asp:TableCell><asp:TableCell ID="TableCell3" Width="5%" runat="server"></asp:TableCell></asp:TableRow></asp:Table><asp:GridView ID="gvAssocProducts" runat="server" Width="100%" Font-Names="Verdana"
                            ...
                            <asp:Table ID="tabAssocProds" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                ...
                                <asp:TableRow>
                                    <asp:TableCell RowSpan="3" Width="5%"></asp:TableCell><asp:TableCell RowSpan="3"
                                        ...
                                        <asp:Label ID="Label3" runat="server" ForeColor="Gray">Product Code:</asp:Label>
                                        ...
                                        <asp:Label ID="Label5" runat="server" ForeColor="Gray">Product Date:</asp:Label>
                                    </asp:TableCell><asp:TableCell Width="20%" VerticalAlign="Top">
                                        <asp:Label ID="Label6" runat="server" ForeColor="Red"><%# DataBinder.Eval(Container.DataItem,"ProductDate") %></asp:Label>
                                    </asp:TableCell><asp:TableCell Width="16%" VerticalAlign="Top" Wrap="False">
                                        <asp:Label ID="Label7" runat="server" ForeColor="Gray">Quantity Available:</asp:Label>
                                    &nbsp;<asp:Label ID="Label8" runat="server" ForeColor="Navy"><%# Format(DataBinder.Eval(Container.DataItem,"QtyAvailable"),"#,##0") %></asp:Label>
                                    </asp:TableCell><asp:TableCell Width="5%"></asp:TableCell></asp:TableRow><asp:TableRow>
                                    ...
                                    </asp:TableCell><asp:TableCell RowSpan="2"></asp:TableCell></asp:TableRow><asp:TableRow>
                                    ...
                                    <asp:TableCell></asp:TableCell><asp:TableCell ColumnSpan="6" VerticalAlign="Top">
                                            <hr />
                                    </asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow></asp:Table></ItemTemplate></asp:TemplateField></Columns></asp:GridView></asp:Panel></asp:Panel><asp:Panel ID="pnlRequestAuthorisation" runat="server" Visible="False" Width="100%">
        <asp:Label ID="Label9" runat="server" Font-Size="X-Small" Font-Names="Arial" ForeColor="#0000C0"
            Font-Bold="True">Request Authorisation</asp:Label><br /><br /><asp:Label ID="Label13" runat="server" Font-Size="XX-Small" Font-Names="Arial">Some items in your basket can only be ordered where authorisation has been granted. Authorisation is required for the products below. Click Request
             Authorisation to start this process, or remove these items from your basket. You will receive an email when authorisation has been granted to order these items, after which you can place your order.</asp:Label><br /><br /><br /><asp:GridView ID="gvRequestAuthorisation" runat="server" AutoGenerateColumns="False"
                ...
                <asp:TemplateField HeaderText="Quantity">
                    <ItemTemplate>
                        <asp:TextBox ID="tbAuthorisationQuantity" Text='<%# Bind("Quantity") %>' runat="server"
                            Width="64px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Status">
                    <ItemTemplate>
                        <asp:Label ID="lblAuthorisationNotes" Text='<%# Eval("Notes") %>' runat="server"
                            ForeColor="Red"></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Request Authorisation">
                    <ItemTemplate>
        ...
        <table>
            <tr>
                <td style="width: 20%; font-size: xx-small; font-family: Verdana;">
                    Note to authoriser (optional): </td><td style="width: 181px">
                    <asp:TextBox ID="tbNoteToAuthoriser" runat="server" TextMode="MultiLine" Width="300px"></asp:TextBox></td><td rowspan="2" style="width: 80px">
                    <asp:LinkButton ID="lnkbtnRequestAuthBackToProducts" runat="server" OnClick="lnkbtnRequestAuthBackToProducts_Click"
                        Font-Names="Verdana" Font-Size="XX-Small">back&nbsp;to&nbsp;products</asp:LinkButton><asp:LinkButton
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small">view&nbsp;basket</asp:LinkButton></td></tr><tr>
        ...
        <br />
        &nbsp;<br /> </asp:Panel><asp:Panel ID="pnlEmptyBasket" runat="server" Visible="False" Width="100%">
        <asp:Table ID="tabEmptyBasket" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
            ...
            <asp:TableRow ID="TableRow2" runat="server">
                <asp:TableCell ID="TableCell4" Width="5%" runat="server"></asp:TableCell><asp:TableCell
                    ID="TableCell5" Width="45%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell6"
                        Width="45%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell7" Width="5%"
                            runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow3" runat="server">
                <asp:TableCell ID="TableCell8" runat="server"></asp:TableCell><asp:TableCell ID="TableCell9"
                ...
                </asp:TableCell><asp:TableCell ID="TableCell10" runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow4" runat="server">
                <asp:TableCell ID="TableCell11" runat="server"></asp:TableCell><asp:TableCell ID="TableCell12"
                    runat="server"></asp:TableCell><asp:TableCell ID="TableCell13" HorizontalAlign="Right"
                        runat="server">
                        <br />
                        <asp:Button ID="Button3" runat="server" OnClick="btn_ContinueWithOrder_click" Text="return to products"
                            ToolTip="go back to browse the stock items" />
                    </asp:TableCell><asp:TableCell ID="TableCell14" runat="server"></asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlDeliveryAddress" runat="server" Visible="False" Width="100%">
        <table id="tabDeliveryAddress" width="100%" style="font-family: Verdana; font-size: x-small;
            ...
            <tr>
                ...
                <td colspan="5">
                    <asp:Label ID="Label59" runat="server" Font-Size="Small" ForeColor="Navy">Instructions</asp:Label><br /><br /><asp:Label ID="Label60" runat="server" Font-Size="XX-Small" ForeColor="Navy">Please 
                    tell us where to deliver your order. When delivering to a company we need a contact name to prevent the consignment being refused on security 
                    grounds. Also, please note that we cannot deliver to a P.O. Box and so a full delivery address is essential.</asp:Label></td><td>
                </td>
            </tr>
            ...
            <tr id="trPostCodeLookupPreamble" runat="server" visible="false">
                ...
                <td colspan="5">
                    <asp:Label ID="Label61" runat="server" Font-Size="X-Small">Post Code Lookup</asp:Label><br /><br /><asp:Label ID="Label62" runat="server" Font-Size="XX-Small" ForeColor="Navy" Text="For UK destinations that are not already in your address book, enter the post code, then click <b>find address</b>. Select the required destination from the list of matching addresses." />
                </td>
                <td>
                </td>
            </tr>
            <tr id="trPostCodeLookupInput" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label63" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red">Post Code:</asp:Label>&nbsp; </td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="6" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPostCodeLookup" Width="100%" MaxLength="10"></asp:TextBox></td><td>
                </td>
                <td colspan="2">
                    ...
                    &nbsp;<asp:Label ID="lblLookupError" runat="server" Visible="False" ForeColor="Red"
                        Font-Size="XX-Small" Font-Names="Verdana"></asp:Label></td><td>
                </td>
            </tr>
            ...
            <%--            <tr id="trMultiAddressOrder" runat="server" visible="false">
                ...
                <td colspan="5">
                    ...
                    &nbsp;<asp:Label ID="Label115" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        Text="otherwise enter the delivery address." ForeColor="Navy"></asp:Label></td><td>
                </td>
            </tr>
            --%>
            <tr>
                ...
                <td>
                    <br />
                    <asp:Label ID="lblLegendDeliveryAddress" runat="server" Font-Size="X-Small" Font-Names="Verdana">Delivery Address</asp:Label></td><td colspan="4">
                    <br />
                    ...
                    &nbsp;<asp:LinkButton ID="lnkbtnGetFromPersonalAddressbook" OnClick="btn_GetFromPersonalAddressBook_click"
                        ...
                        Font-Names="Verdana">view personal address book</asp:LinkButton>&nbsp; </td><td>
                </td>
            </tr>
            <tr>
                <td />
                <td>
                    <asp:Label ID="lblLegendCountry" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">Country:</asp:Label>&nbsp; <asp:CompareValidator 
                        ID="cvCneeCountry" runat="server" ControlToValidate="ddlCneeCountry"
                        Font-Names="Verdana" Font-Size="X-Small" Operator="NotEqual" 
                        ValueToCompare="0" ForeColor="Red" Font-Bold="True">###</asp:CompareValidator></td><td>
                    ...
                    &nbsp;<asp:LinkButton ID="lnkbtnCneeCountryUK" runat="server" CausesValidation="False"
                        Font-Names="Verdana" Font-Size="XX-Small" OnClick="lnkbtnCneeCountryUK_Click">UK</asp:LinkButton>&nbsp;<asp:LinkButton 
                        ID="lnkbtnCneeCountryFR" runat="server" CausesValidation="False" Visible="false"
                        Font-Names="Verdana" Font-Size="XX-Small" onclick="lnkbtnCneeCountryFR_Click">FR</asp:LinkButton></td><td /><td>
                    <asp:Label ID="lblLegendCity" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">City:</asp:Label>&nbsp; <asp:RequiredFieldValidator 
                        ID="rfvCneeCity" runat="server" ControlToValidate="txtCneeCity"
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox ID="txtCneeCity" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy" MaxLength="50" TabIndex="5" Width="100%" search-dependent-field="ddlCneeCountry" CssClass="typeahead"/></td><td /></tr><tr>
                <td>
                </td>
                <td>
                    &nbsp; </td><td>
                ...
                <td>
                    <asp:Label ID="lblLegendRegion" runat="server" Font-Names="Verdana" Font-Size="XX-Small">County / Region:</asp:Label>&nbsp; <asp:RequiredFieldValidator ID="rfvRegion" runat="server" ControlToValidate="ddlUSStatesCanadianProvinces"
                        Enabled="false" Font-Size="XX-Small" Font-Names="Verdana">#</asp:RequiredFieldValidator></td><td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblLegendCnee" runat="server" Font-Bold="True" Font-Names="Verdana"
                        Font-Size="XX-Small" ForeColor="Red">Company:</asp:Label>&nbsp; <asp:RequiredFieldValidator 
                        ID="rfvCneeName" runat="server" ControlToValidate="txtCneeName"
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                ...
                <td>
                    <asp:Label ID="lblLegendPostcodeZipcode" runat="server" Font-Bold="True" Font-Names="Verdana"
                        Font-Size="XX-Small" ForeColor="Red">Post Code:</asp:Label>&nbsp; <asp:RequiredFieldValidator 
                        ID="rfvPostCodeLookup" runat="server" ControlToValidate="txtCneePostCode"
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox ID="txtCneePostCode" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy" MaxLength="10" TabIndex="7" Width="100%"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblLegendCneeAddr1" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">Addr 1:</asp:Label>&nbsp; <asp:RequiredFieldValidator 
                        ID="rfvCneeAddr1" runat="server" ControlToValidate="txtCneeAddr1"
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox ID="txtCneeAddr1" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy" MaxLength="50" TabIndex="2" Width="100%"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="lblLegendCneeCtcName" runat="server" ForeColor="Red" Font-Size="XX-Small"
                        Font-Names="Verdana" Font-Bold="True">Attn of:</asp:Label>&nbsp; <asp:RequiredFieldValidator 
                        ID="rfvCneeCtcName" runat="server" ControlToValidate="txtCneeCtcName"
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="8" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCneeCtcName" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="lblLegendCneeAddr2" runat="server" Font-Names="Verdana" Font-Size="XX-Small">Addr 2:</asp:Label></td><td>
                    <asp:TextBox ID="txtCneeAddr2" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy" MaxLength="50" TabIndex="3" Width="100%"></asp:TextBox></td><td /><td>
                    <asp:Label ID="lblLegendCneeTel" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Contact Tel:</asp:Label>&nbsp; <asp:RequiredFieldValidator ID="rfvCneeTel" runat="server" ControlToValidate="txtCneeTel"
                        Font-Size="XX-Small" Enabled="false">#</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="9" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCneeTel" Width="100%" MaxLength="50"></asp:TextBox></td><td /></tr><tr>
                <td />
                <td>
                    <asp:Label ID="lblLegendCneeAddr3" runat="server" Font-Names="Verdana" Font-Size="XX-Small">Addr 3:</asp:Label></td><td>
                    <asp:TextBox ID="txtCneeAddr3" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy" MaxLength="50" TabIndex="4" Width="100%"></asp:TextBox></td><td /><td>
                    <asp:Label ID="Label76" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Contact Email:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="10" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCneeEmail" Width="100%" MaxLength="50"></asp:TextBox></td><td /></tr><tr>
                <td>
                </td>
                <td colspan="5">
                    <hr />
                ...
                <td>
                    <asp:Label ID="lblLegendCheckoutCustomerRef1" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana">Customer Ref 1:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            ControlToValidate="txtCustRef1" Font-Names="Verdana" 
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCustRef1" Width="100%" MaxLength="25"></asp:TextBox></td><td /><td>
                    <asp:Label ID="lblLegendCheckoutCustomerRef2" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana">Customer Ref 2:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            ControlToValidate="txtCustRef2" Font-Names="Verdana" 
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCustRef2" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
            </tr>
                ...
                <td>
                    <asp:Label ID="lblLegendCheckoutCustomerRef3" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana">Customer Ref 3:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            ControlToValidate="txtCustRef3" Font-Names="Verdana" 
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCustRef3" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="lblLegendCheckoutCustomerRef4" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana">Customer Ref 4:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            ControlToValidate="txtCustRef4" Font-Names="Verdana" 
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtCustRef4" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration1Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label57" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Cost Centre:</asp:Label></td><td>
                ...
                <td>
                    <asp:Label ID="Label58" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">choose from list, or type:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small">#</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration1CostCentre" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration2Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label5" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="red">Booking Ref:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                        ...
                        Font-Size="X-Small" Font-Names="Arial" ForeColor="Red" Font-Bold="true"> ###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration2BookingRef" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="Label31" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref A:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration2AdditionalRefA" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration2Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label32" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref B:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration2AdditionalRefB" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="Label33" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref C:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration2AdditionalRefC" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
            </tr>
                ...
                <td>
                    <asp:Label ID="Label83" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">Cost Centre:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration3CostCentre"
                            runat="server" ControlToValidate="tbPerCustomerConfiguration3CostCentre" Font-Size="X-Small"
                            Font-Names="Arial" ForeColor="Red" Font-Bold="true"> ###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration3CostCentre" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="Label84" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref A:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration3AdditionalRefA" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration4Checkout1" runat="server" visible="false">
                ...
                <td colspan="5">
                    <asp:Label ID="Label133" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">NOTE: You will choose the delivery service (STANDARD or EXPRESS) at the order confirmation stage.</asp:Label></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration3Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label85" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref B:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration3AdditionalRefB" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="Label86" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref C:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration3AdditionalRefC" Width="100%" MaxLength="25"/></td><td>
                </td>
            </tr>
                ...
                <td>
                    <asp:Label ID="Label410cimax" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red">Department/Market:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration6Department"
                            ...
                            Font-Size="X-Small" InitialValue="- please select -" ForeColor="Red" Font-Bold="true"> ###</asp:RequiredFieldValidator></td><td>
                ...
                <td>
                    <asp:Label ID="Label130cimax" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">Cost centre:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration6CostCentre"
                            ...
                            Font-Size="X-Small" Font-Bold="true" ForeColor="Red">###</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                ...
                                Font-Names="Arial" Enabled="False" ForeColor="Red" Font-Bold="true"> ### {123/1234/12345(/1234)}</asp:RegularExpressionValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration6CostCentre" Width="100%" MaxLength="19"/></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration6Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label410cimareference" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red">Reference*:</asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                            ...
                            Font-Size="XX-Small"> #</asp:RequiredFieldValidator></td><td>
                ...
                <td colspan="2">
                    <asp:Label ID="Label410cimarefadvice" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red">* Please note that this description will appear on the invoice to enable you to authorise it.</asp:Label></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration7Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label4" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Red">Service Level:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                        ...
                        runat="server" Font-Names="Arial" Font-Size="XX-Small" InitialValue="- please select -"> #</asp:RequiredFieldValidator></td><td>
                    <asp:DropDownList ID="ddlPerCustomerConfiguration7ServiceLevel" runat="server" Font-Size="XX-Small"
                        ...
                        <asp:ListItem>- please select -</asp:ListItem><asp:ListItem>ECONOMY</asp:ListItem><asp:ListItem>EXPRESS</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                </td>
                <td>
                ...
                <td>
                    <asp:Label ID="Label4vsal18" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red">Service Level:</asp:Label><asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration18ServiceLevel"
                            ...
                            Font-Names="Arial" Font-Size="XX-Small" InitialValue="- please select -"> #</asp:RequiredFieldValidator></td><td>
                    <asp:DropDownList ID="ddlPerCustomerConfiguration18ServiceLevel" runat="server" Font-Size="XX-Small"
                        ...
                        <asp:ListItem>- please select -</asp:ListItem><asp:ListItem>ECONOMY</asp:ListItem><asp:ListItem>EXPRESS</asp:ListItem><asp:ListItem>MAIL</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                </td>
                <td>
                ...
                <td style="height: 24px">
                    <asp:Label ID="Label91c" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">Booking Ref:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3111"
                            ...
                            Font-Size="XX-Small">#</asp:RequiredFieldValidator></td><td style="height: 24px">
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration8BookingRef" Width="100%" MaxLength="20"></asp:TextBox></td><td style="height: 24px">
                </td>
                <td style="height: 24px">
                    <asp:Label ID="Label921" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">PCID:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator311"
                            ...
                            Font-Size="XX-Small">#</asp:RequiredFieldValidator></td><td style="height: 24px">
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration8PCID" Width="100%" MaxLength="50"></asp:TextBox></td><td style="height: 24px">
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration8Checkout2" runat="server" visible="false">
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlPerCustomerConfiguration8Rating" runat="server" Font-Size="XX-Small"
                        ForeColor="Navy" TabIndex="12" Font-Names="Verdana">
                        <asp:ListItem Selected="true">- please select -</asp:ListItem><asp:ListItem Selected="False">INVESTOR</asp:ListItem><asp:ListItem Selected="False">NOSC</asp:ListItem><asp:ListItem Selected="False">POTENTIAL</asp:ListItem><asp:ListItem Selected="False">RO</asp:ListItem><asp:ListItem Selected="False">SIGNED</asp:ListItem><asp:ListItem Selected="False">OTHER</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlPerCustomerConfiguration8RO" runat="server" Font-Size="XX-Small"
                        ForeColor="Navy" TabIndex="12" Font-Names="Verdana">
                        <asp:ListItem Selected="true">- please select -</asp:ListItem><asp:ListItem Selected="False">AUGE</asp:ListItem><asp:ListItem Selected="False">Chicago</asp:ListItem><asp:ListItem Selected="False">Compulsory</asp:ListItem><asp:ListItem Selected="False">GRS</asp:ListItem><asp:ListItem Selected="False">Hong Kong</asp:ListItem><asp:ListItem Selected="False">London </asp:ListItem><asp:ListItem Selected="False">Middle East</asp:ListItem><asp:ListItem Selected="False">Montevideo</asp:ListItem><asp:ListItem Selected="False">None</asp:ListItem><asp:ListItem Selected="False">Swiss Sales</asp:ListItem><asp:ListItem Selected="False">Tokyo</asp:ListItem><asp:ListItem Selected="False">TSS</asp:ListItem><asp:ListItem Selected="False">Other</asp:ListItem></asp:DropDownList></td><td>
                </td>
            </tr>
                ...
                <td>
                    <asp:Label ID="Label910" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">MDS Order Ref:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator30"
                            ...
                            Font-Size="XX-Small">#</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration8MDSOrderRef" Width="100%" MaxLength="20"></asp:TextBox></td><td>
                </td>
                <td>
                </td>
                <td>
            ...
            <tr id="trPerCustomerConfiguration12Checkout1" runat="server" visible="false">
                    ...
                    <asp:Label ID="Label134" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">Cost Code:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfdPerCustomerConfiguration12CostCentre"
                            ...
                            Font-Names="Arial"> #</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                ...
                                runat="server" ControlToValidate="tbPerCustomerConfiguration12CostCentre" Font-Size="XX-Small"
                                Font-Names="Arial"> # (wrong format)</asp:RegularExpressionValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                ...
                <td>
                    <asp:Label ID="Label135" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref A:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration12AdditionalRefA" Width="100%" MaxLength="50"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration12Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label136" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref B:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration12AdditionalRefB" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
                <td>
                    <asp:Label ID="Label137" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Additional Customer Ref C:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration12AdditionalRefC" Width="100%" MaxLength="25"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration17Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label8117" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">Service Level:</asp:Label></td><td>
                    <asp:DropDownList ID="ddlPerCustomerConfiguration17ServiceLevel" runat="server" Font-Size="XX-Small"
                        ...
                        <asp:ListItem Value="courier">Standard Shipping (Courier)</asp:ListItem><asp:ListItem Value="mail">Mail</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                </td>
                <td>
            ...
            <tr id="trPerCustomerConfiguration18Checkout1" runat="server" visible="false">
                ...
                <td colspan="5">
                    <asp:Label ID="Label9699" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">NOTE: Your consignment will be sent ECONOMY unless you specify otherwise in Special Instructions</asp:Label></td><td /></tr><tr id="trPerCustomerConfiguration18Checkout19" runat="server" visible="false">
                <td />
                <td>
                    <asp:Label ID="Label5719" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Cost Centre:</asp:Label></td><td>
            ...
            <tr id="trPerCustomerConfiguration20Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label5720" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="red">Cost Centre:</asp:Label></td><td>
                    ...
                    &nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration20CostCentre" runat="server"
                        ...
                        Font-Names="Verdana" Font-Size="XX-Small" InitialValue="- please select -"></asp:RequiredFieldValidator></td><td /><td /><td /><td /></tr><tr id="trPerCustomerConfiguration21Checkout1" runat="server" visible="false">
                <td />
                <td>
                    <asp:Label ID="lblAPerCustomerConfiguration21CostCentre" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="red">Cost Centre:</asp:Label></td><td>
                ...
                <td>
                    <asp:Label ID="lblBPerCustomerConfiguration21CostCentre" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana">Customer Ref:</asp:Label></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="13" Font-Size="XX-Small" Font-Names="Verdana"
                ...
                <td>
                    <asp:Label ID="Label134arth" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        Font-Bold="true" ForeColor="red">Cost Centre:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            ErrorMessage="###" Font-Names="Verdana" Font-Size="XX-Small" InitialValue="- please select -" ForeColor="Red" />
                </td>
                <td>
            ...
            <tr id="trPerCustomerConfiguration23Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label136arth" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        Font-Bold="true" ForeColor="red">PO Number:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="Red"> ###</asp:RequiredFieldValidator></td><td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                ...
                <td>
                    <asp:Label ID="Label137arth" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Type any further order details in the Special Instructions box</asp:Label></td><td /></tr><tr id="trPerCustomerConfiguration26Checkout1" runat="server" visible="false">
                <td />
                <td>
                    <asp:Label ID="lblRamblersChooseGroup" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Red" Font-Bold="True">Area/Group:</asp:Label>&nbsp;<asp:RequiredFieldValidator
                            ...
                            InitialValue="- please select -" ForeColor="Red" />
                </td>
                <td colspan="4">
                    <asp:LinkButton ID="lnkbtnRamblersGroupAB" CommandArgument="A-B" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">A-B</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupCD" CommandArgument="C-D" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">C-D</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupEG" CommandArgument="E-G" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">E-G</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupHJ" CommandArgument="H-J" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">H-J</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupKL" CommandArgument="K-L" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">K-L</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupMN" CommandArgument="M-N" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">M-N</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupOR" CommandArgument="O-R" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">O-R</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupS" CommandArgument="S" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">S</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupTZ" CommandArgument="T-Z" runat="server" OnClick="lnkbtnRamblersGroup_Click"
                        Font-Names="Verdana" Font-Size="XX-Small" CausesValidation="False">T-Z</asp:LinkButton>&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnRamblersGroupOther" CommandArgument="Other" runat="server"
                        OnClick="lnkbtnRamblersGroup_Click" Font-Names="Verdana" Font-Size="XX-Small"
                        CausesValidation="False">Other</asp:LinkButton></td><td /></tr><tr id="trPerCustomerConfiguration26Checkout2" runat="server" visible="false">
                <td />
                <td>
                </td>
                <td>
                    <asp:DropDownList ID="ddlRamblersAreaGroup" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ...
                        <asp:ListItem>- Select from the alphabetic choices above to find your area/group -</asp:ListItem></asp:DropDownList>&nbsp; </td><td /><td>
                </td>
                <td>
                </td>
                <td />
            ...
            <tr id="trPerCustomerConfiguration29Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="12" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="tbPerCustomerConfiguration29Event" Width="100%" MaxLength="25"></asp:TextBox></td><td /><td>
                    <asp:Label ID="lblIrwinMitchellBDName" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        Font-Bold="true">BD Name:</asp:Label></td><td>
                    <asp:TextBox ID="tbPerCustomerConfiguration29BDName" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" Width="100%" MaxLength="50" />
                </td>
                <td />
            </tr>
            <tr id="trPerCustomerConfiguration30Checkout1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="lblLegendJupiter" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        Font-Bold="true" ForeColor="red">Print Service Level</asp:Label>&nbsp; <asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration30PrintServiceLevel" runat="server"
            ...
            <tr id="trPerCustomerConfiguration30Checkout2" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label137arth0" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">To calculate total elapsed time from ordering to delivery, add the Print Service Level time to the transit time to your destination, as listed in the...</asp:Label><br /><asp:HyperLink ID="HyperLink4" runat="server" Font-Bold="True" Font-Names="Verdana"
                        Font-Size="XX-Small" NavigateUrl="http://my.transworld.eu.com/jupiter/customer_furniture/jupiter/globaltransitguide.pdf"
                        Target="_blank">GLOBAL TRANSIT GUIDE</asp:HyperLink></td><td>
                </td>
                <td>
                    <asp:Label ID="lblLegendPerCustomerConfiguration30TotalPrintCost2" runat="server"
                        Font-Names="Verdana" Font-Size="XX-Small">Total Print Cost:</asp:Label></td><td>
                    <asp:Label ID="lblPerCustomerConfiguration30TotalPrintCost" runat="server" Font-Bold="true"
                        Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></td><td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration31Checkout1" runat="server" visible="false">
                <td>
                </td>
                <td>
                    <asp:Label ID="Label31opus1" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">Service Level:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration31ServiceLevel"
                            runat="server" ControlToValidate="ddlPerCustomerConfiguration31ServiceLevel"
                            Font-Names="Arial" Font-Size="XX-Small" InitialValue="0" Font-Bold="true" ForeColor="Red"> ###</asp:RequiredFieldValidator></td><td>
                    <asp:DropDownList ID="ddlPerCustomerConfiguration31ServiceLevel" runat="server" Font-Size="XX-Small"
                        ForeColor="Navy" TabIndex="12" Font-Names="Verdana" AutoPostBack="True" OnSelectedIndexChanged="ddlPerCustomerConfiguration31ServiceLevel_SelectedIndexChanged">
                        <asp:ListItem Value="0">- please select -</asp:ListItem><asp:ListItem Value="STANDARD">Standard</asp:ListItem><asp:ListItem Value="EXPRESS">Express</asp:ListItem><asp:ListItem Value="SAME DAY">Same Day</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                </td>
                <td>
            ...
            <tr id="trPerCustomerConfiguration32Checkout1" runat="server" visible="false">
                <td>
                </td>
                <td>
                        <asp:Label ID="Label32jameshardie1" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Red">Customer Type:</asp:Label>&nbsp;<asp:RequiredFieldValidator ID="rfvPerCustomerConfiguration32CustomerType"
                            runat="server" ControlToValidate="ddlPerCustomerConfiguration32CustomerType"
                            Font-Names="Arial" Font-Size="XX-Small" InitialValue="0" ForeColor="Red"> ###</asp:RequiredFieldValidator>&nbsp;</td><td>
                        <asp:DropDownList 
                            ID="ddlPerCustomerConfiguration32CustomerType" runat="server" Font-Size="XX-Small"
                        ForeColor="Navy" TabIndex="12" Font-Names="Verdana" AutoPostBack="True" 
                            onselectedindexchanged="ddlPerCustomerConfiguration32CustomerType_SelectedIndexChanged"><asp:ListItem Value="0">- please select -</asp:ListItem><asp:ListItem Value="ARCHITECT">Architect</asp:ListItem><asp:ListItem 
                            Value="BUILDER">Builder</asp:ListItem><asp:ListItem Value="CONTRACTOR">Contractor</asp:ListItem><asp:ListItem 
                            Value="DEALER">Dealer</asp:ListItem><asp:ListItem Value="HOMEOWNER">Homeowner</asp:ListItem><asp:ListItem 
                            Value="OTHER">Other</asp:ListItem></asp:DropDownList></td><td>
                </td>
                <td>
                <asp:Label ID="lblLegend32JamesHardieOtherDetail" runat="server" Font-Names="Verdana" 
                        Font-Size="XX-Small" ForeColor="Red" Visible="False">Other detail:</asp:Label>&nbsp;<asp:RequiredFieldValidator 
                        ID="rfvPerCustomerConfiguration32OtherDetail" runat="server" ForeColor="Red" 
                        ControlToValidate="tbPerCustomerConfiguration32OtherDetail" 
                        Font-Names="Verdana" Font-Size="XX-Small" Font-Bold="True">###</asp:RequiredFieldValidator></td><td>
                <asp:TextBox 
                        ID="tbPerCustomerConfiguration32OtherDetail" runat="server" Font-Names="Verdana" 
                        Font-Size="XX-Small" MaxLength="40" Width="100%" Visible="False" /></td>
                <td>
                </td>
            </tr>
            <tr id="trPerCustomerConfiguration32Checkout2" runat="server" visible="false">
                <td>
                </td>
                <td colspan="5"><asp:RadioButton ID="rbJamesHardieIncludeCoverLetterUK" runat="server" 
                            Font-Names="Verdana" Font-Size="XX-Small" Forecolor="Navy"
                            GroupName="IncludeJamesHardieCoverLetter" 
                            oncheckedchanged="rbJamesHardieIncludeCoverLetter_CheckedChanged" 
                            Text="Include cover letter - UK" AutoPostBack="True" />&nbsp; <asp:RadioButton 
                            ID="rbJamesHardieIncludeCoverLetterFrance" runat="server" Font-Names="Verdana" 
                            Font-Size="XX-Small" Forecolor="Navy" GroupName="IncludeJamesHardieCoverLetter" 
                            oncheckedchanged="rbJamesHardieIncludeCoverLetter_CheckedChanged" 
                            Text="Include cover letter - France" AutoPostBack="True" />&nbsp; <asp:RadioButton 
                            ID="rbJamesHardieIncludeCoverLetterGermany" runat="server" Font-Names="Verdana" 
                            Font-Size="XX-Small" Forecolor="Navy" GroupName="IncludeJamesHardieCoverLetter" 
                            oncheckedchanged="rbJamesHardieIncludeCoverLetter_CheckedChanged" 
                            Text="Include cover letter - Germany" AutoPostBack="True" /></td>
                <td>
                </td>
            </tr>
            <tr>
            ...
            <tr id="trPerCustomerConfiguration1Checkout2" runat="server" visible="false">
                ...
                <td colspan="5">
                    <span style="font-size: xx-small; color: red; font-family: Verdana">Please click <a
                        href="javascript:void(window.open('http://my.transworld.eu.com/info/transit_times.pdf','','resizable=yes,location=no,menubar=no,scrollbars=yes,status=no,toolbar=no,fullscreen=no,dependent=no'))"><strong>here</strong></a> to view standard delivery times to worldwide locations.
                        ...
                        Instructions" below.</span><br /> <br /><asp:Label ID="Label23" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
            ...
            <tr id="trPerCustomerConfiguration0CheckoutDeliveryDateCalendar" runat="server" visible="false">
                ...
                <td colspan="5">
                    <span style="font-size: xx-small; color: red; font-family: Verdana">Please click <a
                        ...
                        e.g. in "Special Instructions" below.</span><br /> <br /><span id="spnPerCustomerConfiguration0CheckoutDeliveryDateCalendar" runat="server"
                        visible="true"><asp:Label ID="lblPerCustomerConfiguration0CheckoutDeliveryDateCalendar" runat="server"
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:RequiredFieldValidator ID="rfvInstructions" runat="server" ControlToValidate="txtSpecialInstructions"
                        Enabled="false" Font-Names="Verdana" Font-Size="XX-Small">#</asp:RequiredFieldValidator></td><td colspan="4">
                    <asp:TextBox runat="server" ForeColor="Red" TabIndex="16" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtSpecialInstructions" Width="100%" MaxLength="1000"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr id="trCheckoutPackingNoteText" runat="server" visible="true">
                ...
                <td>
                    <asp:Label ID="lblLegendPackingNoteText" runat="server" Font-Size="XX-Small" Font-Names="Verdana">Packing Note Text:</asp:Label></td><td colspan="4">
                    <asp:TextBox runat="server" ForeColor="Red" TabIndex="16" Font-Size="XX-Small" Font-Names="Verdana"
                        ID="txtShippingInfo" Width="100%" MaxLength="1000"></asp:TextBox></td><td>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="lblCheckOutMessage" runat="server" BackColor="#F9D938" ForeColor="Navy"
                        Font-Names="Verdana" Font-Size="X-Small"></asp:Label></td><td colspan="3" align="right">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    &nbsp;&nbsp; <asp:LinkButton ID="lnkbtnUseSharedAddressbook" runat="server" OnClick="lnkbtnUseSharedAddressbook_Click">use shared address book</asp:LinkButton><asp:LinkButton
                        ID="lnkbtnUsePersonalAddressBook" runat="server" OnClick="lnkbtnUsePersonalAddressBook_Click">use personal address book</asp:LinkButton><br /><br /><asp:Label ID="Label99" runat="server" Font-Size="XX-Small" ForeColor="Navy">Use your address book to save re-typing the delivery address.</asp:Label></td><td style="width: 5px">
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        Font-Names="Verdana" ForeColor="Navy">Search for:</asp:Label><asp:TextBox runat="server"
                            ...
                            ToolTip="search criteria" MaxLength="50"></asp:TextBox><asp:Label ID="Label1x" runat="server"
                                Font-Names="Verdana" Font-Size="XX-Small" ForeColor="Navy">in</asp:Label><asp:DropDownList
                                    ...
                                    <asp:ListItem Value="0">all fields</asp:ListItem><asp:ListItem Value="1">company name</asp:ListItem></asp:DropDownList>&nbsp;<asp:Button ID="btn_SearchAddresses" OnClick="btn_SearchAddresses_Click" runat="server"
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="lblAddressMessage" runat="server" ForeColor="Red" Font-Names="Verdana"
                        Font-Size="X-Small"></asp:Label></td><td style="width: 5px">
                </td>
            </tr>
        </table>
        <br />
    ...
    <asp:Panel ID="pnlConfirmBooking" runat="server" Visible="False" Width="100%">
        <table style="width: 100%; font-size: x-small; font-family: Verdana" cellpadding="2"
            ...
            <tr runat="server" id="trFinalCheckDefault" visible="true">
                <td />
                <td colspan="5">
                    <asp:Label ID="Label43" runat="server" Font-Size="Small" ForeColor="Navy">Order: Final Check</asp:Label><br /><br /><asp:Label ID="Label44" runat="server" Font-Size="XX-Small" ForeColor="Navy">Please check the information below before submitting your order for processing. Once we receive your order we will send you an email confirming our acceptance of your instructions.</asp:Label><br /></td><td /></tr><tr runat="server" id="trFinalCheckOrderAuthorisation" visible="true">
                <td />
                <td colspan="5">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblAuthorisationAdvisory02" runat="server" Font-Size="XX-Small" ForeColor="Navy">Please check the information below before submitting your order for authorisation. You can add an optional message to the authoriser in the box below.</asp:Label><br /><br /><asp:TextBox ID="tbAuthoriserMessageSingleAddressOrder" MaxLength="500" BackColor="lightYellow"
                        Font-Names="Verdana" Font-Size="xX-Small" Width="100%" TextMode="multiLine" runat="server"></asp:TextBox></td><td /></tr><tr>
                <td />
                <td colspan="5">
                    <hr />
                </td>
            ...
            <tr>
                ...
                <td valign="top" align="right">
                    <asp:Label ID="Label45" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">From</asp:Label>&nbsp;&nbsp;&nbsp; </td><td valign="top">
                ...
                <td valign="top" align="right">
                    <asp:Label ID="Label46ytr" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">To</asp:Label>&nbsp;&nbsp;&nbsp; </td><td valign="top">
            ...
            <tr id="trStandardConfirmationCustRef1" runat="server" visible="true">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendConfirmationCustomerRef1" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="Navy">Reference 1</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendConfirmationCustomerRef2" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="Navy">Reference 2</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trStandardConfirmationCustRef2" runat="server" visible="true">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendConfirmationCustomerRef3" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="Navy">Reference 3</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendConfirmationCustomerRef4" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="Navy">Reference 4</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                    <asp:Label ID="lblCustRef4" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy"></asp:Label></td><td /></tr><tr id="trPerCustomerConfiguration1Confirmation1" runat="server" visible="false">
                <td />
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label8xxx" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Cost Centre</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration2Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label34" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Booking Ref</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label37" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Additional Customer Ref A</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration2Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label38" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Additional Customer Ref B</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label39" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Additional Customer Ref C</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration3Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    ...
                    <asp:Label ID="lblPerCustomerConfiguration3ConfirmationCostCentre" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy"></asp:Label></td><td /><td style="white-space: nowrap" align="right">
            ...
            <tr id="trPerCustomerConfiguration4Confirmation1" runat="server" visible="False">
                ...
                <td style="white-space: nowrap" align="right">
                    ...
                    &nbsp;<asp:CompareValidator 
                        ID="cvPerCustomerConfiguration4Confirmation1ServiceLevel" runat="server"
                        ...
                        Font-Size="X-Small" ForeColor="Red" Font-Bold="True">###</asp:CompareValidator></td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblPerCustomerConfiguration4Confirmation1NotUsed2" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy"></asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration4Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendPerCustomerConfiguration4Confirmation2TotalValue" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy">Total value for this booking (€):</asp:Label></td><td>
                    ...
                    <asp:Label ID="lblLegendPerCustomerConfiguration4Confirmation2EstimatedFreightCharges"
                        runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy">Estimated freight charges on </asp:Label><asp:Label
                            ...
                            Font-Names="Verdana" ForeColor="Navy"></asp:Label><asp:Label ID="lblLegendPerCustomerConfiguration4Confirmation2Kilos"
                                runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy"> kilos (£):</asp:Label></td><td>
            ...
            <tr id="trPerCustomerConfiguration6Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label49cimax" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Department</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration6Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label49cimaxreference" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Reference</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration7Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label35" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Service Level</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration8Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label9698" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">PCID</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration8Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label9697b" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Rating</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label9697a" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">RO</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration8Confirmation3" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label9696" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">MDS Order Ref</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration12Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label138" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Cost Code</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration21Confirmation1" runat="server" visible="false">
                ...
                <td>
                    <asp:Label ID="Label51220vvf" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Cust Ref:</asp:Label></td><td>
            ...
            <tr id="trPerCustomerConfiguration23Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label139arth" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Category</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration23Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label140arth" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">PO Number</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration25Confirmation1" runat="server" visible="False">
                ...
                <td style="white-space: nowrap" align="right">
                    ...
                    &nbsp;<asp:CompareValidator ID="cvPerCustomerConfiguration25Confirmation1ServiceLevel"
                        ...
                        Font-Size="X-Small" Font-Bold="true" ForeColor="Red">###</asp:CompareValidator></td><td>
            ...
            <tr id="trPerCustomerConfiguration25Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendPerCustomerConfiguration25Confirmation2ConsignmentWeight"
                        runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy">Approx weight of this consignment (Kg):</asp:Label></td><td>
            ...
            <tr id="trPerCustomerConfiguration29Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label138im" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Budget Code</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration29Confirmation2" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label140im" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Event</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblIMConfBDName" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">BD Name</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration30Confirmation1" runat="server" visible="false">
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="LabelJupiter3" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Print Service Level</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="LabelJupiter4" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Total Print Cost</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
            ...
            <tr id="trPerCustomerConfiguration31Confirmation1" runat="server" visible="false">
                <td />
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label31opus2" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Service Level</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                    <asp:Label ID="lblPerCustomerConfiguration31ConfirmationServiceLevel" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy" />
                </td>
                <td />
                <td />
            ...
            <tr id="trPerCustomerConfiguration32Confirmation1" runat="server" visible="false">
                <td />
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label31jameshardie1" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy">Customer Type</asp:Label>&nbsp;&nbsp;&nbsp; </td><td>
                    <asp:Label ID="lblPerCustomerConfiguration32ConfirmationCustomerType" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy" />
                </td>
                <td />
                <td />
            ...
            <tr id="trPerCustomerConfiguration33Confirmation1" runat="server" visible="False">
                <td />
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="Label89sense" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                        ForeColor="Navy" Text="Service level: " />
                    <asp:DropDownList 
                        ID="ddlPerCustomerConfiguration33Confirmation1ServiceLevel" runat="server"
                        AutoPostBack="True" Font-Size="XX-Small" 
                        onselectedindexchanged="ddlPerCustomerConfiguration33Confirmation1ServiceLevel_SelectedIndexChanged" />&nbsp;<asp:CompareValidator ID="cvPerCustomerConfiguration33Confirmation1ServiceLevel"
                        runat="server" ValueToCompare="0" Operator="NotEqual" Font-Names="Verdana" ControlToValidate="ddlPerCustomerConfiguration33Confirmation1ServiceLevel"
                        Font-Size="X-Small" Font-Bold="true" ForeColor="Red">###</asp:CompareValidator></td><td>
                    <asp:Label ID="lblPerCustomerConfiguration33Confirmation1NotUsed1" runat="server"
                        Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Navy" />
                </td>
                <td />
                <td style="white-space: nowrap" align="right">
            ...
            <tr>
                ...
                <td style="white-space: nowrap" align="right">
                    <asp:Label ID="lblLegendSpecialInstructionsConfirmation" runat="server" Font-Size="XX-Small"
                        Font-Names="Verdana" ForeColor="Navy" Text="Special Instructions"></asp:Label>&nbsp;&nbsp;&nbsp; </td><td colspan="4">
            ...
            <tr id="trConfirmationPackingNoteText" runat="server" visible="true">
                ...
                <td align="right" style="white-space: nowrap">
                    <asp:Label ID="Label50ywy" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy">Packing Note Text</asp:Label>&nbsp;&nbsp;&nbsp; </td><td colspan="4">
            ...
            <tr>
                ...
                <td colspan="5">
                    <asp:Label ID="lblLegendStockItems" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ForeColor="Navy">Stock Items</asp:Label><br /><asp:DataGrid ID="gvConfirmationBasket" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Qty" Visible="True">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label48ccprh" runat="server" ForeColor="Navy"><%# Format((DataBinder.Eval(Container, "DataItem.QtyToPick")),"##,##0") %></asp:Label></ItemTemplate></asp:TemplateColumn><asp:TemplateColumn>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    &nbsp;&nbsp;</ItemTemplate></asp:TemplateColumn><asp:TemplateColumn HeaderText="Price" Visible="True">
                                <HeaderStyle Font-Underline="True" HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <asp:Label ID="Label48ccprh" runat="server" ForeColor="Navy" Visible='<%# sSetIsCABVisibility %>'><%# Format((DataBinder.Eval(Container, "DataItem.UnitValue")),"##,##0.00") %></asp:Label></ItemTemplate></asp:TemplateColumn><asp:TemplateColumn HeaderText="Total" Visible="True">
                                <HeaderStyle Font-Underline="True" HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <asp:Label ID="Label48" runat="server" ForeColor="Navy" Visible='<%# sSetIsCABVisibility %>'><%# Format((DataBinder.Eval(Container, "DataItem.QtyToPick")) * (DataBinder.Eval(Container, "DataItem.UnitValue")),"##,##0.00") %></asp:Label></ItemTemplate></asp:TemplateColumn></Columns></asp:DataGrid></td><td /></tr><tr id="trMaterialsTotal" runat="server" visible='<%# sSetIsCABVisibility %>'>
                <td />
            ...
            <tr>
                <td />
                <td colspan="5" align="right">
                    <asp:LinkButton ID="lnkbtnSaveAddressInPersonalAddressBook" runat="server" OnClick="lnkbtnSaveAddressInPersonalAddressBook_Click">save address in personal address book</asp:LinkButton>&nbsp;&nbsp;&nbsp; <asp:LinkButton ID="lnkbtnSaveAddressInSharedAddressBook" runat="server" OnClick="lnkbtnSaveAddressInSharedAddressBook_Click">save address in shared address book</asp:LinkButton>&nbsp;&nbsp;&nbsp; <asp:Button ID="btnFinalCheckGoBack" runat="server" CausesValidation="false" OnClick="btn_CheckOut_click"
    ...
    <asp:Panel ID="pnlBookingConfirmation" runat="server" Visible="False" Width="100%">
        <asp:Table ID="Table1" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana"
            ...
            <asp:TableRow ID="TableRow5" runat="server">
                <asp:TableCell ID="TableCell15" Width="5%" runat="server"></asp:TableCell><asp:TableCell
                    ID="TableCell16" Width="10%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell17"
                        Width="33%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell18" Width="2%"
                            runat="server"></asp:TableCell><asp:TableCell ID="TableCell19" Width="10%" runat="server"></asp:TableCell><asp:TableCell
                                ID="TableCell20" Width="33%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell21"
                                    Width="5%" runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow6" runat="server">
                <asp:TableCell ID="TableCell22" runat="server"></asp:TableCell><asp:TableCell ID="TableCell23"
                ...
                </asp:TableCell><asp:TableCell ID="TableCell24" runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow7" runat="server">
                <asp:TableCell ID="TableCell25" runat="server"></asp:TableCell><asp:TableCell ID="TableCell26"
                    ColumnSpan="2" runat="server">
                    <asp:Label ID="Label12" runat="server" ForeColor="Navy" Font-Names="Verdana" Font-Size="X-Small">Consignment No</asp:Label>&nbsp;&nbsp;
                </asp:TableCell><asp:TableCell ID="TableCell27" ColumnSpan="3" runat="server">
                    <asp:Label ID="lblConsignmentNo" runat="server" ForeColor="Red" Font-Names="Verdana"
                        Font-Size="X-Small"></asp:Label>
                </asp:TableCell><asp:TableCell ID="TableCell28" runat="server"></asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlBookingQueuedConfirmation" runat="server" Visible="False" Width="100%">
        <asp:Table ID="Table4" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana"
            ...
            <asp:TableRow ID="TableRow8" runat="server">
                        ...
                        Width="33%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell40" Width="2%"
                            runat="server"></asp:TableCell><asp:TableCell ID="TableCell41" Width="10%" runat="server"></asp:TableCell><asp:TableCell
                                ID="TableCell69" Width="33%" runat="server"></asp:TableCell><asp:TableCell ID="TableCell70"
                                    Width="5%" runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow9" runat="server">
                ...
                </asp:TableCell><asp:TableCell ID="TableCell73" runat="server"></asp:TableCell></asp:TableRow><asp:TableRow ID="TableRow12" runat="server">
                ...
                </asp:TableCell><asp:TableCell ID="TableCell77" runat="server"></asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlClassicProductList" runat="server" Visible="False" Width="100%">
        <asp:Table ID="Table5" runat="Server" Width="90%">
            <asp:TableRow>
                ...
                <asp:TableCell></asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow></asp:Table><asp:Label ID="lblClassicProductMessage" runat="server" Font-Names="Verdana" Font-Size="X-Small"
            ForeColor="#00C000"></asp:Label><asp:DataGrid ID="dgrdProducts" runat="server" Font-Size="XX-Small"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <HeaderTemplate>
                            Info</HeaderTemplate><ItemTemplate>
        ...
        <asp:Table ID="Table6" runat="Server" Font-Size="X-Small" Width="100%" Font-Names="Verdana">
            <asp:TableRow>
                ...
                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlClassicBasket" runat="server" Visible="False" Width="100%">
        <asp:Label ID="Label100" runat="server" Font-Names="Verdana" Font-Size="X-Small"
            ForeColor="#0000C0" Font-Bold="True">&nbsp;Your Basket</asp:Label><br /><br /><asp:Label ID="lblClassicBasketMessage" runat="server" Font-Names="Verdana" Font-Size="X-Small"
                ...
                <asp:DataGrid ID="dgrdBasket" runat="server" Font-Size="XX-Small" Width="100%" Font-Names="Verdana"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <HeaderTemplate>
                                Qty to Pick</HeaderTemplate><ItemTemplate>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Font-Bold="True" Font-Names="Verdana"
                                    ForeColor="Red" runat="Server" Text=">>>" ControlToValidate="txtPickQuantity"></asp:RequiredFieldValidator><asp:TextBox
                                        ID="txtPickQuantity" Font-Size="XX-Small" Width="40px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.QtyToPick") %>'></asp:TextBox></ItemTemplate><FooterStyle HorizontalAlign="Center"></FooterStyle>
                        </asp:TemplateColumn>
                    </Columns>
                </asp:DataGrid>
            </div>
        <asp:Table ID="Table7" runat="Server" Font-Size="X-Small" Width="100%" Font-Names="Verdana">
            <asp:TableRow>
                ...
                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlClassicProductDetail" runat="server" Visible="False">
        <asp:Label ID="Label116" runat="server" Font-Names="Verdana" Font-Size="X-Small"
            ForeColor="#0000C0" Font-Bold="True">Product
            details</asp:Label><br /><br /><asp:Table ID="Table13" runat="server" Font-Size="XX-Small" Width="750px" Font-Names="Verdana">
            <asp:TableRow>
                <asp:TableCell></asp:TableCell><asp:TableCell ColumnSpan="4" HorizontalAlign="Right"></asp:TableCell></asp:TableRow><asp:TableRow>
                ...
                </asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="pnlCalendarManaged" runat="server" Visible="False" Width="100%">
        <strong>&nbsp;Calendar Managed Products</strong><br /> <table style="width: 100%">
            <tr>
                <td style="width: 10%">
                </td>
                <td style="width: 30%">
        ...
        <table style="width: 100%">
            ...
            <tr>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlnk_ThumbNail2" runat="server" ToolTip="click here to see larger image"
                                        NavigateUrl='<%# "Javascript:SB_ShowImage(""" & DataBinder.Eval(Container.DataItem,"OriginalImage") & """)" %> '
                                        ImageUrl='<%# psVirtualThumbFolder & DataBinder.Eval(Container.DataItem,"ThumbNailImage") & "?" & Now.ToString %>'></asp:HyperLink></ItemTemplate></asp:TemplateField><asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="lblCalendarManagedItemProductCode" Text='<%# DataBinder.Eval(Container.DataItem,"ProductCode") %>'
                                        runat="server" Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField>
                                <ItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblCalendarManagedItemDescription" Text='<%# DataBinder.Eval(Container.DataItem,"Description") %>'
                                        runat="server" Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></ItemTemplate></asp:TemplateField></Columns></asp:GridView></td></tr><tr>
                <td style="width: 1%">
                </td>
                ...
                <td style="width: 35%" valign="top" align="center">
                    <strong>
                        <asp:Label ID="Label53" runat="server" Font-Names="Verdana" Font-Size="X-Small" Text="Enter event details"></asp:Label></strong></td><td style="width: 1%">
                </td>
            ...
            <tr>
                        ...
                        <tr>
                            <td align="right" style="white-space: nowrap">
                                <asp:Label ID="Label46" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    Text="Delivery date:"></asp:Label></td><td>
                                <asp:Label ID="lblCMDeliveryDate" runat="server" Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></td></tr><tr>
                            <td align="right" style="white-space: nowrap">
                                <asp:Label ID="Label50" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    Text="Collection date:"></asp:Label></td><td>
                                <asp:Label ID="lblCMCollectionDate" runat="server" Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></td></tr><tr>
                            <td align="center" colspan="2">
                                <asp:LinkButton ID="lnkbtnCMClearDateSelection" runat="server" OnClick="lnkbtnCMClearDateSelection_Click"
                                    Font-Names="Verdana" Font-Size="XX-Small">clear date selection</asp:LinkButton><br /><asp:LinkButton ID="lnkbtnFindAvailableProducts" runat="server" Font-Names="Verdana"
                                    Font-Size="XX-Small" OnClick="lnkbtnFindAvailableProducts_Click" Visible="False">find available products</asp:LinkButton></td></tr><tr>
                            <td colspan="2" style="height: 181px">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 25%" align="center">
                                            <asp:Label ID="Label87sdfg" runat="server" Font-Bold="True" Font-Names="Verdana"
                                                Font-Size="XX-Small" Text="Key:"></asp:Label></td><td style="width: 75%">
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td style="width: 30%" align="right">
                                ...
                                <asp:Label ID="Label2axa" runat="server" ForeColor="Red" Text="Event name:" Font-Names="Verdana"
                                    Font-Size="XX-Small"></asp:Label></td><td style="width: 70%">
                                <asp:TextBox ID="tbCMEventName" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    Width="100%" MaxLength="50"></asp:TextBox></td></tr><tr>
                            <td align="right">
                                <asp:RequiredFieldValidator ID="rfvCMContactName" ControlToValidate="tbCMContactName"
                                    ...
                                    Font-Size="XX-Small"></asp:RequiredFieldValidator><asp:Label ID="Label6axa" runat="server"
                                        ForeColor="Red" Text="Contact name:" Font-Names="Verdana" Font-Size="XX-Small"></asp:Label></td><td>
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:Label ID="Label15axa" runat="server" ForeColor="Red" Text="Contact phone:" Font-Names="Verdana"
                                    Font-Size="XX-Small"></asp:Label></td><td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:LinkButton ID="lnkbtnCMAddressOutsideUK" runat="server" Font-Names="Verdana"
                                    ...
                                    outside UK</asp:LinkButton></td></tr><tr id="trCMSelectEventAddress" runat="server" visible="false">
                            <td align="right">
                                ...
                                <asp:LinkButton ID="lnkbtnCMCancelSelectEventAddress" runat="server" Font-Names="Verdana"
                                    Font-Size="XX-Small" OnClick="lnkbtnCMCancelSelectEventAddress_Click">cancel</asp:LinkButton></td><td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCMItemDeliverBy" runat="server" Font-Names="Verdana" Font-Size="XX-Small">
                                    <asp:ListItem>- please select -</asp:ListItem><asp:ListItem>9.00am</asp:ListItem><asp:ListItem>10.30am</asp:ListItem><asp:ListItem>12.00 noon</asp:ListItem><asp:ListItem Value="Other times pls specify in Special Instructions">Other 
                                        times pls specify in Special Instructions</asp:ListItem></asp:DropDownList></td></tr><tr>
                            <td align="right">
                                ...
                                <asp:Label ID="Label43axa" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    ForeColor="Red" Text="Exact delivery point:"></asp:Label></td><td>
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:Label ID="Label44axa" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    ForeColor="Red" Text="Collect between:"></asp:Label></td><td>
                                <asp:DropDownList ID="ddlCMItemCollectBetween" runat="server" Font-Names="Verdana"
                                    Font-Size="XX-Small">
                                    <asp:ListItem>- please select -</asp:ListItem><asp:ListItem>9.00am - 10.00am</asp:ListItem><asp:ListItem>10.00am - 11.00am</asp:ListItem><asp:ListItem>11.00am - 12.00 noon</asp:ListItem><asp:ListItem>12.00 noon - 1.00pm</asp:ListItem><asp:ListItem>1.00pm - 2.00pm</asp:ListItem><asp:ListItem>2.00pm - 3.00pm</asp:ListItem><asp:ListItem>3.00pm - 4.00pm</asp:ListItem><asp:ListItem>4.00pm - 5.00pm</asp:ListItem><asp:ListItem>5.00pm - 6.00pm</asp:ListItem><asp:ListItem>Other - contact Transworld</asp:ListItem></asp:DropDownList></td></tr><tr id="trCMCollectionPostcode" runat="server" visible="false">
                            <td align="right">
                                ...
                                &nbsp; <asp:LinkButton ID="lnkbtnCMFindCollectionAddress" runat="server" Font-Names="Verdana"
                                    Font-Size="XX-Small" OnClick="lnkbtnCMFindCollectionAddress_Click">find addr</asp:LinkButton>&nbsp;<asp:Label
                                        ...
                                        Font-Size="XX-Small" ForeColor="Red" Text="no results found  !!" Visible="False"></asp:Label>&nbsp;<asp:LinkButton
                                            ...
                                            OnClick="lnkbtnCMCollectionAddressOutsideUK_Click">addr outside UK</asp:LinkButton></td></tr><tr id="trCMSelectCollectionAddress" runat="server" visible="false">
                            <td align="right" style="height: 59px">
                                <asp:Label ID="Label80" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                    Text="Select address:"></asp:Label><br /><br /><asp:LinkButton ID="lnkbtnCMCancelSelectCollectionAddress" runat="server" Font-Names="Verdana"
                                    Font-Size="XX-Small" OnClick="lnkbtnCMCancelSelectCollectionAddress_Click">cancel</asp:LinkButton></td><td style="height: 59px">
                ...
                <td style="width: 42%" valign="top">
                    ...
                    <asp:GridView ID="gvOtherCalendarManagedReservations" runat="server" CellPadding="2"
                        ...
                        <EmptyDataTemplate>
                            no events found</EmptyDataTemplate></asp:GridView></td></tr></table><br /></asp:Panel><asp:Panel ID="pnlFindAvailableProducts" runat="server" Font-Names="Verdana" Font-Size="X-Small"
            ...
            <tr>
                ...
                <td style="width: 95%">
                    <asp:GridView ID="gvCMAvailableProducts" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ...
                        <EmptyDataTemplate>
                            no available products found for the selected dates(s)</EmptyDataTemplate></asp:GridView></td></tr><tr>
                <td>
                </td>
                <td>
    ...
    &nbsp;&nbsp;<asp:Label ID="lblError" runat="server" ForeColor="Red" Font-Names="Verdana"
        Font-Size="X-Small"></asp:Label></form><script language="JavaScript" type="text/javascript" src="wz_tooltip.js"></script><script language="JavaScript" type="text/javascript" src="library_functions.js"></script></body></html>