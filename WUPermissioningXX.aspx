...
<script runat="server">
    ...
    Protected Sub SetTitle()
        ...
        If sTitle <> String.Empty Then
            sTitle += " - "
        End If
        Page.Header.Title = sTitle & "Western Union Permissioning"
    End Sub
    ...
    Protected Sub btnGenerateReport_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        WebMsgBox.Show("This report is not yet available.")
        Exit Sub
        ...
        sbText.Append("<hr />")
        Call NewLine(sbText)
        Dim dtUsers As DataTable = ExecuteQueryToDataTable("SELECT UserID + ' (' + FirstName + ' ' + LastName + ')' User, UserPermissions FROM UserProfile WHERE lp.CustomerKey IN (579, 686, 798) And UserPermissions > 0 ORDER BY UserID")
        For Each drUser As DataRow In dtUsers.Rows

            ' report which permissions this user has
        ...
        ' now go through dtUsers matching each permission type and reporting which users have that permission
    ...
    <asp:Panel ID="pnlNewMessage" runat="server" Width="100%">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td colspan="4">
                    <asp:Label ID="lblLegendTopicType" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Small" ForeColor="Navy" Text="Western Union Permissioning" />
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr id="trFindAccount" runat="server" visible="false">
                ...
                <td colspan="3">
                    <telerik:RadComboBox ID="rcbUser" runat="server" AutoPostBack="True" CausesValidation="False" EnableLoadOnDemand="True" 
                        EnableVirtualScrolling="True" Filter="Contains" Font-Names="Verdana" Font-Size="XX-Small" HighlightTemplatedItems="true" 
                        OnItemsRequested="rcbUser_ItemsRequested" Width="300px"
                        ShowMoreResultsBox="True" ToolTip="Shows all users when no search text is specified. Search for users by typing an agent code or name." />
                    &nbsp;<asp:LinkButton ID="lnkbtnClearFilter" runat="server" Font-Names="Verdana" Font-Size="XX-Small" onclick="lnkbtnClearFilter_Click" >clear filter</asp:LinkButton>
                    &nbsp;<asp:Button ID="btnEditPermissions" runat="server" Text="Edit permissions" onclick="btnEditPermissions_Click" />
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr id="trModifyPermissions2" runat="server" visible="true">
                ...
                <td colspan="3">
                    <asp:CheckBox ID="cbIsWUInternalUser" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Is WU Internal User" AutoPostBack="True" oncheckedchanged="cbIsWUInternalUser_CheckedChanged" />
                    &nbsp;<asp:CheckBox ID="cbCreateDeleteAccounts" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Create / delete accounts" />
                    &nbsp;<asp:CheckBox ID="cbResetPasswords" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Reset passwords" />
                    &nbsp;<asp:CheckBox ID="cbViewProducts" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="View products" />
                    &nbsp;<asp:CheckBox ID="cbOrderProducts" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Order products" />
                    &nbsp;&nbsp;<asp:CheckBox ID="cbAccessReports" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Access reports" />
                    &nbsp;<asp:CheckBox ID="cbIsTSE" runat="server" Font-Names="Arial" Font-Size="XX-Small" Text="Is a TSE" />
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr ID="trModifyPermissions2a" runat="server" visible="true">
                ...
                <td align="right">
                    &nbsp;</td>
                <td colspan="3">
                    <asp:CheckBox ID="cbIsPilotUser" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="XX-Small" oncheckedchanged="cbIsWUInternalUser_CheckedChanged" Text="Is Pilot User" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr id="trModifyPermissions3" runat="server" visible="true">
                ...
                <td colspan="3">
                    <asp:Button ID="btnSavePermissions" runat="server" Text="Save" Width="100px" Height="26px" onclick="btnSavePermissions_Click" />
            ...
            <tr runat="server" ID="trUserGrid2" visible="false">
                ...
                <td colspan="3">
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" CellPadding="2" Font-Names="Arial" Font-Size="XX-Small" OnRowDataBound="gvUsers_RowDataBound" Width="100%">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button ID="btnEdit" runat="server" CommandArgument='<%# Container.DataItem("UserKey")%>' OnClick="btnEdit_Click" Text="edit" />
                                </ItemTemplate>
