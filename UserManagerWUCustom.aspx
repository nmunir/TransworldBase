...
<script runat="server">
        ...
        ElseIf e.CommandSource.CommandName = "Email" Then
            ...
            If plSelectedUserKey > 0 Then
                ...
                Try
                    ...
                    End If
                    tbAccessDetailsMessageText.Text += "Here is your user ID and password to access the Sprint online system." & vbCrLf
    ...
    Protected Sub btnSendEmail_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim sSubject As String = "Your account details for accessing the Sprint online system"
    ...
    Protected Sub btnRenameUserGroup_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        tbRenameUserGroupNewName.Text = lbDefinedUserGroups.SelectedValue
    ...
    Protected Sub btnUsersReport_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For Each liGroupName As ListItem In oListItemCollectionA
            Dim oListItemCollection2 As ListItemCollection = ExecuteQueryToListItemCollection("SELECT [Key] UserKey, FirstName + ' ' + LastName + ' (' + UserId + ')' UserName FROM UserProfile WHERE CustomerKey = " & Session("CustomerKey") & " AND UserGroup = " & liGroupName.Value & " ORDER BY FirstName", "UserKey", "UserName")
            sbText.Append("<hr />")
        ...
        Call NewLine(sbText)
        sbText.Append("<hr />")
        Dim oListItemCollection6 As ListItemCollection = ExecuteQueryToListItemCollection("SELECT [Key] UserKey, FirstName + ' ' + LastName + ' (' + UserId + ')' UserName FROM UserProfile WHERE Type = 'SuperUser' AND CustomerKey = " & Session("CustomerKey") & " ORDER BY FirstName", "UserKey", "UserName")
    ...
    <form id="frmUserManager" runat="Server">
        ...
        <asp:Panel id="pnlSystemUser" runat="server" visible="False" Width="100%">
            <table style="width:100%; font-family:Verdana; font-size:x-small">
                <tr valign="middle">
                    <td align="left" valign="middle" style="white-space:nowrap; height: 27px;">
                        <asp:DropDownList id="ddlCustomerAccountCodes" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCustomerAccountCodes_changed" Font-Names="Verdana" Font-Size="XX-Small"/>
                        <asp:CheckBox ID="cbOnlyListAccountsWithProducts" runat="server" Checked="True"
                            Font-Names="Verdana" Font-Size="XX-Small" Text="accts with products only" AutoPostBack="True" OnCheckedChanged="cbOnlyListAccountsWithProducts_CheckedChanged" />
                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnShowAllUsers" runat="server" Text="show all users" OnClick="btnShowAllUsers_Click" />
                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label13" Font-Size="XX-Small" Font-Names="Verdana" runat="server" Text="search" />&nbsp;<asp:TextBox runat="server" Width="80px" Font-Size="XX-Small" Font-Names="Verdana" ID="txtSearchCriteriaAllCustomers" ></asp:TextBox>
                        <asp:Button ID="btnGo" runat="server" Text="go" OnClick="btnGo_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cbIncludeSuspendedUsers" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                        ...
                        &nbsp;&nbsp;<asp:Button ID="btnExportUserList" runat="server" Text="export user list" OnClick="btnExportUserDetails_click" />
                ...
                <tr>
                    <td colspan="2" style="white-space:nowrap">
                        <asp:Label ID="Label1" runat="server" font-size="X-Small" font-names="Verdana">Selected Customer: </asp:Label> <asp:Label runat="server" forecolor="Gray" id="lblCustomerName" font-size="X-Small" font-names="Verdana"></asp:Label>
                    </td>
                </tr>
            </table>
            <br />
            <asp:DataGrid id="dgSystemAdministrator" runat="server" Width="100%" Font-Names="Verdana" Font-Size="XX-Small" OnPageIndexChanged="dgSystemAdministrator_Page_Change" AllowPaging="True" Visible="False" AutoGenerateColumns="False" GridLines="None" ShowFooter="True" OnItemCommand="Edit_User">
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="CustomerAccountCode" SortExpression="CustomerAccountCode" HeaderText="Customer">
                        <HeaderStyle font-bold="True" forecolor="Gray"></HeaderStyle>
                        <ItemStyle wrap="False"></ItemStyle>
                    </asp:BoundColumn>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnProductProfile" visible='<%# bSetProductProfileButtonVisibility(Container.DataItem) %>' CommandName="ProductProfile" runat="server" Text="product profile" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
            <div id="divSystemUserControls" runat="server" visible="false">
                        ...
                        <asp:DropDownList ID="ddlUsersPerSystemUserPage" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" onselectedindexchanged="ddlUsersPerSystemUserPage_SelectedIndexChanged">
            ...
            <asp:RadioButton ID="rbSystemUserUserID" runat="server" AutoPostBack="True" Checked="True" Font-Names="Verdana" Font-Size="XX-Small" GroupName="OrderBySystemUser" Text="User ID" oncheckedchanged="rbSystemUserUserID_CheckedChanged" />
        <asp:RadioButton ID="rbSystemUserUserName" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" GroupName="OrderBySystemUser" Text="User Name" oncheckedchanged="rbSystemUserUserName_CheckedChanged" />
        <asp:RadioButton ID="rbSystemUserCustomerName" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" GroupName="OrderBySystemUser" Text="Customer Name" oncheckedchanged="rbSystemUserCustomerName_CheckedChanged" />
        </div>
        </asp:Panel>
            <br />
        <asp:Label id="lblSystemUserMessage" runat="server" forecolor="Gray" font-size="X-Small" font-names="Verdana"></asp:Label>
        <asp:Panel id="pnlCustomerUser" runat="server" visible="False" Width="100%">
            <table style="width:100%; font-family:Verdana; font-size:x-small">
                <tr valign="middle">
                    <td align="left" valign="middle" style="white-space:nowrap">
                        <asp:Button ID="btnShowAllCustomerProfiles" onclick="btnShowAllCustomerProfiles_click" runat="server" Text="show all users" />
                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label14" Font-Size="XX-Small" Font-Names="Verdana" runat="server" Text="search" />&nbsp;<asp:TextBox runat="server" Width="80px" Font-Size="XX-Small" Font-Names="Arial" ID="txtSearchCriteriaCustomer"></asp:TextBox>
                        <asp:Button ID="btnSSearchUsers" onclick="btn_SearchUsers_Click" runat="server" Text="go" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cbIncludeSuspendedUsers2" runat="server" Font-Names="Verdana" Font-Size="XX-Small"
                                  Text="+ suspended users" AutoPostBack="true" OnCheckedChanged="cbIncludeSuspendedUsers_CheckedChanged" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnSystemUserAddNewUser" onclick="btn_AddUser_click" runat="server" Text="add new user" />
                        &nbsp;&nbsp;<asp:Button ID="Button20" runat="server" Text="export user list" OnClick="btnExportUserDetails_click" />
                        <asp:Button ID="Button3" runat="server" OnClick="btnUserGroups_Click" Text="groups" /></td>
                    <td align="right" valign="middle" style="white-space:nowrap">
                        &nbsp;</td>
                </tr>
            </table>
            <br />
            <asp:DataGrid id="dgSuperUser" runat="server" Width="100%" Font-Names="Verdana" Font-Size="XX-Small" OnPageIndexChanged="dgSuperUser_Page_Change" AllowPaging="True" Visible="False" AutoGenerateColumns="False" GridLines="None" ShowFooter="True" OnItemCommand="Edit_User" PageSize="11" OnItemDataBound="dgSuperUser_ItemDataBound">
                <FooterStyle wrap="False"></FooterStyle>
                <HeaderStyle font-names="Verdana" wrap="False"></HeaderStyle>
                <PagerStyle font-size="X-Small" font-bold="True" horizontalalign="Center" forecolor="Blue" backcolor="Silver" wrap="False" mode="NumericPages"></PagerStyle>
                <AlternatingItemStyle backcolor="White"></AlternatingItemStyle>
                <ItemStyle backcolor="LightGray"></ItemStyle>
                <Columns>
                    <asp:BoundColumn Visible="False" DataField="Key">
                    ...
                    <asp:TemplateColumn>
                        <ItemStyle horizontalalign="Right"></ItemStyle>
                        <ItemTemplate>
                            <asp:Button ID="btnSuperUserProductProfile" visible='<%# bSetProductProfileButtonVisibility(Container.DataItem) %>' CommandName="ProductProfile" runat="server" Text="product profile" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
            <div id="divSuperUserControls" runat="server" visible="false">
                        ...
                        <asp:DropDownList ID="ddlUserPerSuperUserPage" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" onselectedindexchanged="ddlUserPerSuperUserPage_SelectedIndexChanged">
                        <asp:ListItem Selected="True">10</asp:ListItem>
                        <asp:ListItem>50</asp:ListItem>
                        <asp:ListItem>250</asp:ListItem>
                        </asp:DropDownList>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:RadioButton ID="rbSuperUserUserID" runat="server" AutoPostBack="True" Checked="True" Font-Names="Verdana" Font-Size="XX-Small" GroupName="OrderBySuperUser" Text="User ID" oncheckedchanged="rbSuperUserUserID_CheckedChanged" />
        <asp:RadioButton ID="rbSuperUserUserName" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" GroupName="OrderBySuperUser" Text="User Name" oncheckedchanged="rbSuperUserUserName_CheckedChanged" />
        </div>
            <br />
            <asp:Label id="lblSuperUserMessage" runat="server" forecolor="Gray" font-size="X-Small" font-names="Verdana"></asp:Label>
        </asp:Panel>
        ...
        <asp:Panel id="pnlAddEditUser" runat="server" visible="False" Width="100%">
            <table style=" font-family:Verdana; font-size:xx-small; color:Gray" width="100%">
                <tr valign="middle">
                    <td align="left" valign="middle">
                        <asp:Label ID="lbl001" runat="server" forecolor="Gray" font-size="X-Small" font-names="Verdana" font-bold="True" Text="User Profile"></asp:Label>
                    </td>
                    <td align="Right" valign="middle">
                        ...
                        &nbsp;&nbsp;<asp:Button ID="btnReturnToMyPanel" onclick="btn_ReturnToMyPanel_click" runat="server" Text="go back" />
                    </td>
                </tr>
                <tr valign="middle">
            ...
            <table id="tbl001"  width="100%" style="font-family:Verdana; font-size:xx-small; color:Gray" >
                <tr>
                    <td valign="top">
                        <table style="color:Gray; width:95%; font-size:xx-small; font-family:Verdana">
                            <tr>
                                <td style="width:20px"></td>
                                <td style="width:300px"><asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Website Usage<br />"/></td>
                                <td style="width:300px"/>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label5" runat="server">Book Courier Collections</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="chkAbleToCreateCollectionRequest" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label15" runat="server">View (but not order) Stock</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="chkAbleToViewStock" Font-Size="XX-Small" AutoPostBack="True" OnCheckedChanged="chkAbleToViewStock_CheckedChanged"/></td>
                            </tr>
                            <tr>
                                <td>
                                </td>
                                <td>
                                    <asp:Label ID="Label6" runat="server">Order Stock</asp:Label></td>
                                <td>
                                    <asp:CheckBox runat="server" ID="chkAbleToCreateStockBookings" Font-Size="XX-Small" AutoPostBack="True" OnCheckedChanged="chkAbleToCreateStockBookings_CheckedChanged"/></td>
                            </tr>
                            <tr>
                                <td style="height: 18px"/>
                                <td style="height: 18px"><asp:Label ID="Label7" runat="server" Font-Bold="True" Text="Stock Emailing Options<br />" /></td>
                                <td style="height: 18px"/>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label8" runat="server" Text="Receive Own Booking Confirmation"/></td>
                                <td><asp:CheckBox runat="server" ID="chkStockBookingAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="lblLegendReceiveAllBookingConfirmations" runat="server">Receive ALL Booking Confirmations</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="chkStockBookingAlertAll" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label10" runat="server" Text="Receive Goods-In Alerts"/></td>
                                <td><asp:CheckBox runat="server" ID="chkStockArrivalAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label11" runat="server" Text="Receive Low Stock Alerts"/></td>
                                <td><asp:CheckBox runat="server" ID="chkLowStockAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trCourierEmailingOptions01" runat="server">
                                <td/>
                                <td><asp:Label ID="Label12" runat="server" Font-Bold="True" Text="Courier Emailing Options<br />" /></td>
                                <td/>
                            </tr>
                            <tr id="trCourierEmailingOptions02" runat="server">
                                <td/>
                                <td><asp:Label ID="Label5a" runat="server">Receive Own Booking Confirmation</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="chkCourierBookingAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trCourierEmailingOptions03" runat="server">
                                <td/>
                                <td><asp:Label ID="Label5b" runat="server" Text="Receive ALL Booking Confirmations"/></td>
                                <td><asp:CheckBox runat="server" ID="chkCourierBookingAlertAll" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trCourierEmailingOptions04" runat="server">
                                <td/>
                                <td><asp:Label ID="Label5c" runat="server" Text="Receive AWB Despatch Alerts"/></td>
                                <td><asp:CheckBox runat="server" ID="chkAWBDespatchAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trCourierEmailingOptions05" runat="server">
                                <td/>
                                <td><asp:Label ID="Label5d" runat="server" Text="Receive AWB Delivery Confirmation"/></td>
                                <td><asp:CheckBox runat="server" ID="chkAWBDeliveryAlert" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trUserPublicationOptions01" runat="server" visible="false">
                                <td/>
                                <td><asp:Label ID="Label12upo" runat="server" Font-Bold="True" Text="User Publication Options<br />" /></td>
                                <td/>
                            </tr>
                            <tr id="trUserPublicationOptions02" runat="server" visible="false">
                                <td/>
                                <td><asp:Label ID="Label5upo2" runat="server">Receive Own User Publications Booking Confirmations</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="cbUserPublicationsOwnBookingAlerts" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trUserPublicationOptions03" runat="server" visible="false">
                                <td/>
                                <td><asp:Label ID="Label5upo2a" runat="server">Receive ALL User Publications Booking Confirmations</asp:Label></td>
                                <td><asp:CheckBox runat="server" ID="cbUserPublicationsAllBookingAlerts" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trUserPublicationOptions04" runat="server" visible="false">
                                <td/>
                                <td><asp:Label ID="Label5bupo3" runat="server" Text="Receive Own Publication Inactivity Alerts"/></td>
                                <td><asp:CheckBox runat="server" ID="cbUserPublicationsOwnInactivityAlerts" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr id="trUserPublicationOptions05" runat="server" visible="false">
                                <td/>
                                <td><asp:Label ID="Label5bupo3a" runat="server" Text="Receive ALL Publication Inactivity Alerts"/></td>
                                <td><asp:CheckBox runat="server" ID="cbUserPublicationsAllInactivityAlerts" Font-Size="XX-Small"/></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label5e" runat="server" Font-Bold="True" Text="Address Book"/></td>
                                <td/>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Labelf" runat="server">View Global Address Book</asp:Label>
                                 </td>
                                <td>
                            ...
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label5g" runat="server" Text="Edit Global Address Book"/></td>
                                <td><asp:CheckBox runat="server" ID="chkEditGlobalAddressBook" Font-Size="XX-Small"/></td>
                            </tr>
                        </table>
                    </td>
                    <td valign="top">
                        <table style=" color:Gray; font-size:xx-small; font-family:Verdana">
                            <tr>
                                <td style="width:20px"></td>
                                <td style="width:150px"><asp:Label ID="lblCompany989" runat="server">Company</asp:Label>
                                </td>
                            ...
                            <tr>
                                <td/>
                                <td><asp:Label runat="server" ID="lblFirstName" ForeColor="Red">First Name</asp:Label>
                                    &nbsp;
                                    <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtFirstName">###</asp:RequiredFieldValidator>
                                  </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="1" Font-Names="Verdana" ID="txtFirstName" MaxLength="50" Font-Size="XX-Small"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label runat="server" ID="lblLastName" ForeColor="Red">Last Name</asp:Label>
                                    &nbsp;
                                    <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="txtLastName">###</asp:RequiredFieldValidator>
                                   </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="2" Font-Names="Verdana" ID="txtLastName" MaxLength="50" Font-Size="XX-Small"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label runat="server" ID="lblUserId" ForeColor="Red">User ID</asp:Label>
                                    &nbsp;
                                    <asp:RequiredFieldValidator ID="rfvUserId" runat="server" ControlToValidate="txtUserId">###</asp:RequiredFieldValidator>
                                 </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="3" Font-Names="Verdana" Font-Size="XX-Small" ID="txtUserId" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label runat="server" ID="lblPassword" ForeColor="Red">Password</asp:Label>
                                    &nbsp;
                                    <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="txtPassword">###</asp:RequiredFieldValidator>
                                  </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="4" Font-Names="Verdana" Font-Size="XX-Small" ID="txtPassword" MaxLength="12"></asp:TextBox>
                                    <asp:CheckBox ID="cbForcePasswordChange" Text="force password change" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="Label18" runat="server">User cannot change password</asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td/>
                                <td><asp:Label runat="server" ID="lblEmailAddr" ForeColor="Red">Email Address</asp:Label>
                                    &nbsp;
                                    <asp:RequiredFieldValidator ID="rfvEmailAddr" runat="server" ControlToValidate="txtEmailAddr">###</asp:RequiredFieldValidator>
                                 </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="5" Font-Names="Verdana" Width="180px" Font-Size="XX-Small" ID="txtEmailAddr" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="trTelephone" runat="server">
                                <td/>
                                <td><asp:Label ID="lblTelephoneNo" runat="server">Telephone No</asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="5" Font-Names="Verdana" Width="180px" Font-Size="XX-Small" ID="txtTelephone" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="trHysterDealershipCode" runat="server">
                                ...
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="5" Font-Names="Verdana" Width="180px" Font-Size="XX-Small" ID="txtDealershipCode" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="5" Font-Names="Verdana" Width="180px" Font-Size="XX-Small" ID="txtCollectionPoint" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td><asp:Label ID="lblAccessLevel" runat="server">Access Level</asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="6" Font-Names="Verdana" Font-Size="XX-Small" Enabled="False" ID="txtAccessLevel" MaxLength="20"></asp:TextBox>&nbsp;&nbsp;<asp:LinkButton ID="lnkbtnPromoteToSuperUser"  OnClick="lnkbtnPromoteToSuperUser_Click" OnClientClick='return confirm("Are you sure you want to promote this user to superuser privilege?");' runat="server" Width="70px" style="height: 12px">promote&nbsp;to&nbsp;superuser</asp:LinkButton>&nbsp;<a id="aAccessLevelHelp" visible="true" runat="server" onmouseover="return escape('Gives the selected user <b>superuser</b> privilege. Once the user has been granted this access level, it cannot be revoked.')" style="color:gray; cursor:help">&nbsp;&nbsp;&nbsp;&nbsp;?&nbsp;</a>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td>
                                    <asp:Label ID="lblDepartment" runat="server" Text="Cost Centre" /></td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="7" Font-Names="Verdana" Font-Size="XX-Small" ID="txtDepartment" MaxLength="20"></asp:TextBox>
                                    </td>
                            </tr>
                            <tr id="trUserGroup" runat="server" visible="false">
                                ...
                                <td>
                                    <asp:Label ID="lblUserGroup" runat="server" ForeColor="Red">User Group</asp:Label>&nbsp; &nbsp;<asp:RequiredFieldValidator
                                        ID="rfvUserGroup" runat="server" ControlToValidate="ddlUserGroup" EnableClientScript="False" InitialValue="0">###</asp:RequiredFieldValidator></td>
                                <td>
                            ...
                            <tr>
                                <td/>
                                <td><asp:Label ID="lblUserStatus" runat="server">User Status</asp:Label>
                                </td>
                                <td>
                                    <asp:RadioButtonList runat="server" ForeColor="Gray" TabIndex="8" Font-Size="XX-Small" Font-Names="Verdana" RepeatDirection="Horizontal" ID="btnlst_UserStatus">
                            ...
                            <tr>
                                <td/>
                                <td><asp:Label ID="lblRunningHeader" runat="server">Running Header</asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ForeColor="Navy" TabIndex="9" Font-Names="Verdana" Width="180px" Font-Size="XX-Small" ID="txtRunningHeaderImage" MaxLength="100">default</asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                ...
                                <td align="right" runat="server">
                                    <br/>
                                    <asp:Button ID="Button12" onclick="btn_SaveUserProfileChanges_click" runat="server" Text="save" Width="80px" />
                                    &nbsp;&nbsp;<asp:Button ID="Button1" onclick="btn_ReturnToMyPanel_click" runat="server" Text="cancel" CausesValidation="False" Width="80px" />
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <asp:Panel ID="pnlEmail" runat="server" visible="false" Width="100%" >
            <table style="font-family:Verdana; font-size:x-small; color:Gray" width="100%">
                <tr valign="middle">
                    <td align="left" valign="middle">
                        <asp:Label ID="Label2" runat="server" forecolor="Gray" font-size="X-Small" font-names="Verdana" font-bold="True">Email User Access Details</asp:Label>
                    </td>
                    <td align="right" valign="middle">
                        ...
                        &nbsp;&nbsp;<asp:Button ID="Button2" onclick="btn_ReturnToMyPanel_click" runat="server" Text="go back" />
                    </td>
                </tr>
                <tr valign="middle">
                    <td valign="middle" colspan="2" align="left">
        ...
        <br />
        <asp:TextBox ID="tbAccessDetailsMessageText" runat="server" Height="64px" TextMode="MultiLine" Width="401px"></asp:TextBox><br />
        <br />
        <table style="font-size: x-small; color: gray; font-family: Verdana">
            <tr>
                ...
                <td style="width: 145px">
                    <asp:Label ID="lblAccessDetailsUserID" runat="server"></asp:Label></td>
            </tr>
            <tr>
                ...
                <td style="width: 145px; height: 18px">
                    <asp:Label ID="lblAccessDetailsPassword" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 120px">
                    Email Address:</td>
                ...
                <td style="width: 145px">
                    <asp:TextBox ID="tbAccessDetailsEmail" runat="server" Width="250px"></asp:TextBox></td>
            </tr>
        </table>
        <br />
        ...
        <asp:Panel id="pnlProductProfile" runat="server" visible="False" Width="100%">
            ...
            <table style="font-family:Verdana; font-size:x-small" width="100%">
                <tr valign="middle">
                    <td colspan="2" align="left" valign="middle" style="font-size: xx-small; color: gray; font-family: Verdana">
                    The settings on this page control what products the selected user can view for ordering, and for each product whether there is maximum per-order quantity limit. A maximum order quantity of 0 signifies no limit.<br /><br />
                    </td>
                </tr>
                <tr valign="middle">
                    <td align="left" valign="middle" style="white-space:nowrap">
                        <asp:Button ID="btnShowAllProducts" onclick="btn_ShowAllProducts_click" 
                            runat="server" Text="show all products..." />
                        &nbsp;<asp:CheckBox ID="cbShowAllowToOrder" runat="server" Checked="True" 
                            Font-Names="Verdana" Font-Size="XX-Small" Text="allowed to order" />
                        &nbsp;<asp:CheckBox ID="cbShowNotAllowToOrder" runat="server" Checked="True" 
                            Font-Names="Verdana" Font-Size="XX-Small" Text="NOT allowed to order" />
                        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label4a" runat="server" 
                            Font-Names="Verdana" Font-Size="XX-Small" Text="search"></asp:Label>
                        &nbsp;<asp:TextBox runat="server" Width="120px" Font-Size="XX-Small" Font-Names="Verdana" ID="txtUserProfileProdSeach"/>
                    <asp:Button ID="btnSearchProducts" onclick="btn_SearchProducts_click" runat="server" Text="go" />
                    </td>
                    <td align="right" valign="middle" style="white-space:nowrap">
                        <asp:Button ID="Button13" onclick="btn_SaveUserProductProfileChanges_click" runat="server" Text="save changes" />
                        <asp:Button ID="Button5" onclick="btn_ReturnToMyPanel_click" runat="server" Text="go back" />
                    </td>
                </tr>
                <tr>
                    <td valign="middle" style="white-space:nowrap">
                        <asp:Label ID="lbl004" runat="server">User: </asp:Label> <asp:Label runat="server" forecolor="Navy" id="lblProdProfileUserName"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                        <asp:Label ID="lblProductProfileSearchResult" runat="server" Font-Bold="True" 
                            Font-Names="Verdana" Font-Size="XX-Small" ForeColor="Red" visible="False">No matching records</asp:Label>
                    </td>
                    <td align="right" valign="middle" style="white-space:nowrap">
                        <asp:Label id="lblDefaultMaxGrabQty" runat="server" visible="False" Font-Names="Verdana" Font-Size="XX-Small">Default max order
                        qty:</asp:Label>&nbsp;
                        <asp:TextBox id="txtDefaultGrabQty" runat="server" Visible="False" Font-Names="Verdana" Font-Size="XX-Small" Width="50px" Height="20">0</asp:TextBox>&nbsp;
                    </td>
                </tr>
            </table>
            <asp:DataGrid id="dgUserProducts" runat="server" Width="100%" 
                Font-Names="Verdana" Font-Size="XX-Small" Visible="False" 
                AutoGenerateColumns="False" GridLines="None" ShowFooter="True" 
                AllowSorting="True" OnSortCommand="SortUsersProductsGrid" AllowPaging="True" 
                 OnPageIndexChanged="dgUserProducts_PageIndexChanged">
                <HeaderStyle font-size="10pt" font-names="Arial" wrap="False" bordercolor="Gray"></HeaderStyle>
                <AlternatingItemStyle backcolor="White"></AlternatingItemStyle>
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="ProductCode" SortExpression="ProductCode" HeaderText="Code">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" forecolor="Blue" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False"></ItemStyle>
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="ProductDate" SortExpression="ProductDate" HeaderText="Date">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" forecolor="Blue" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False"></ItemStyle>
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="ProductDescription" SortExpression="ProductDescription" HeaderText="Description">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" forecolor="Blue" verticalalign="Bottom"></HeaderStyle>
                    </asp:BoundColumn>
                    <asp:BoundColumn Visible="False" DataField="LanguageId" SortExpression="LanguageId" HeaderText="Language">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" forecolor="Blue" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False"></ItemStyle>
                    </asp:BoundColumn>
                    <asp:BoundColumn Visible="False" DataField="ProductDepartmentId" SortExpression="ProductDepartmentId" HeaderText="Cost Centre">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" forecolor="Blue" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False"></ItemStyle>
                    </asp:BoundColumn>
                    ...
                    <asp:TemplateColumn HeaderText="Allow Pick">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" horizontalalign="Center" forecolor="Gray" width="6%" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False" horizontalalign="Center"></ItemStyle>
                        <HeaderTemplate>
                            <asp:Button ID="btnTogglePickButton" onclick="btn_ToggleAllowPick_Click" runat="server" Text="select all" />
                            <br />
                            <asp:Label runat="server" font-size="XX-Small" font-names="Verdana">allow to order</asp:Label>&nbsp;
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:CheckBox checked='<%# DataBinder.Eval(Container, "DataItem.AbleToPick") %>' runat="server"></asp:CheckBox>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Apply Max Grab">
                        <HeaderStyle font-size="XX-Small" font-names="Verdana" font-bold="True" wrap="False" horizontalalign="Center" forecolor="Gray" verticalalign="Bottom"></HeaderStyle>
                        <ItemStyle wrap="False" horizontalalign="Center"></ItemStyle>
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:CheckBox checked='<%# DataBinder.Eval(Container, "DataItem.ApplyMaxGrab ") %>' runat="server"></asp:CheckBox>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Quantity">
                        ...
                        <ItemStyle wrap="False" horizontalalign="Center"></ItemStyle>
                        <HeaderTemplate>
                            <asp:Button ID="btnApplyMaxGrabQty" onclick="btn_ApplyMaxGrabQty_Click" runat="server" Text="apply qty" />
                            <br />
                            <asp:Label id="Label1" runat="server" font-size="XX-Small" font-names="Verdana">max
                            order qty</asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:TextBox id="txtMaxGrabQty" runat="server" Font-Names="Verdana" Font-Size="XX-Small" Width="50px" Text='<%# DataBinder.Eval(Container, "DataItem.MaxGrabQty") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
                <PagerStyle HorizontalAlign="Center" Mode="NumericPages" />
            </asp:DataGrid>
            <table width="100%" id="tblSaveCancelProductProfile" runat="server" visible="false" style="font-family:Verdana; font-size= x-small">
                <tr>
                    <td align="left">
                        <asp:Label ID="Label23" runat="server" Font-Names="Verdana" Font-Size="XX-Small" Text="Products / page:" />
                        &nbsp;<asp:DropDownList ID="ddlUsersPerPage" runat="server" AutoPostBack="True" Font-Names="Verdana" Font-Size="XX-Small" onselectedindexchanged="ddlUsersPerPage_SelectedIndexChanged">
                            <asp:ListItem Selected="True">10</asp:ListItem>
                            <asp:ListItem>50</asp:ListItem>
                            <asp:ListItem>200</asp:ListItem>
                            <asp:ListItem>1000</asp:ListItem>
                        </asp:DropDownList>
                        &nbsp;<asp:Label ID="lblSortValue1" runat="server" Font-Names="Verdana" 
                            Font-Size="XX-Small" Text="(Sorting on "></asp:Label>
                        <asp:Label ID="lblSortValue" runat="server" Font-Bold="True" 
                            Font-Names="Verdana" Font-Size="XX-Small" Text="Product Code"></asp:Label><asp:Label ID="lblSortValue0" runat="server" Font-Names="Verdana" Font-Size="XX-Small" Text=")"/>
                    </td>
                    <td align="right" valign="middle">
                        <asp:Button ID="Button13bis" onclick="btn_SaveUserProductProfileChanges_click" runat="server" Text="save changes" />
                        &nbsp;&nbsp;<asp:Button ID="Button6" onclick="btn_ReturnToMyPanel_click" runat="server" Text="cancel" />
                    </td>
                </tr>
            </table>
                ...
                <table width="700px" style="font-family:Verdana; font-size:x-small">
                    ...
                    <tr align="center" >
                        <td align="center">
                            <asp:Panel id="pnlsaUser" runat="server">
                                <asp:RadioButtonList id="rblSaUser" OnSelectedIndexChanged="rblSaUser_IndexChanged" AutoPostBack="True" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Gray">
                            ...
                            <asp:Panel id="pnlInternalSuperUserEnhanced" runat="server">
                                <asp:RadioButtonList id="rblInternalSuperUserWithProductOwner" AutoPostBack="True" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Gray" OnSelectedIndexChanged="rblInternalSuperUserWithProductOwner_SelectedIndexChanged">
                                    <asp:ListItem Value="AccountHandler">Account Handler</asp:ListItem>
                                    <asp:ListItem Value="SuperUser">Super User</asp:ListItem>
                                    <asp:ListItem Value="Product Owner">Product Owner</asp:ListItem>
                                    <asp:ListItem Value="User">User</asp:ListItem>
                            ...
                            <asp:Panel id="pnlInternalSuperUser" runat="server">
                                <asp:RadioButtonList id="rblInternalSuperUser" OnSelectedIndexChanged="rblInternalSuperUser_IndexChanged" AutoPostBack="True" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Gray">
                                    <asp:ListItem Value="AccountHandler">Account Handler</asp:ListItem>
                                    <asp:ListItem Value="SuperUser">Super User</asp:ListItem>
                                    <asp:ListItem Value="User">User</asp:ListItem>
                                </asp:RadioButtonList>
                            ...
                            <asp:Panel id="pnlSuperUserWithProductOwner" runat="server">
                                <asp:RadioButtonList id="rblSuperUserWithProductOwner" AutoPostBack="True" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Gray" OnSelectedIndexChanged="rblSuperUserWithProductOwner_SelectedIndexChanged">
                                    <asp:ListItem Value="SuperUser">Super User</asp:ListItem>
                                    <asp:ListItem Value="Product Owner">Product Owner</asp:ListItem>
                                    <asp:ListItem Value="User">User</asp:ListItem>
                                </asp:RadioButtonList>
                            ...
                            <asp:Panel id="pnlSuperUser" runat="server">
                                <asp:RadioButtonList id="rblSuperUser" OnSelectedIndexChanged="rblSuperUser_IndexChanged" AutoPostBack="True" runat="server" Font-Size="XX-Small" Font-Names="Verdana" ForeColor="Gray">
                                    <asp:ListItem Value="SuperUser">Super User</asp:ListItem>
                                    <asp:ListItem Value="User">User</asp:ListItem>
                                </asp:RadioButtonList>
                            </asp:Panel>
                    ...
                    <tr align="center" >
                        <td align="center">
                            ...
                            <asp:Button ID="Button8" onclick="btn_ReturnToMyPanel_click" runat="server" Text="cancel" /></td>
                    </tr>
                </table>
            </div>
        </asp:Panel>
        <asp:Panel id="pnlDatabaseError" runat="server" visible="False" Width="100%">
            <p>
                <asp:Table id="Table15" runat="server" Width="100%" Font-Names="Arial" Font-Size="X-Small">
                    ...
                    <asp:TableRow HorizontalAlign="Center" >
                        <asp:TableCell HorizontalAlign="Center">
                            <asp:Label id="lblDBError" runat="server" font-size="X-Small" font-names="Arial" forecolor="Red"></asp:Label>
            ...
            <asp:Table ID="tbl006" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana">
                <asp:TableRow VerticalAlign="Middle">
                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" wrap="False"></asp:TableCell><asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" wrap="False">
                        ...
                        &nbsp;&nbsp;<asp:Button ID="Button9" onclick="btn_ReturnToMyPanel_click" runat="server" Text="go back" />&nbsp;
                    </asp:TableCell></asp:TableRow></asp:Table><asp:Table id="tabConfirmDeleteCollection" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana" ForeColor="Gray">
                <asp:TableRow>
            ...
            <asp:Table ID="tbl006zzz" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana">
                <asp:TableRow VerticalAlign="Middle">
                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" wrap="False"></asp:TableCell><asp:TableCell HorizontalAlign="Right" VerticalAlign="Middle" wrap="False">
                        &nbsp;&nbsp;<asp:Button ID="Button9zzz" onclick="btn_ReturnToMyPanel_click" runat="server" Text="go back" />&nbsp;
                    </asp:TableCell></asp:TableRow></asp:Table><asp:Table id="tabConfirmPermissionsChange" runat="server" Width="100%" Font-Size="X-Small" Font-Names="Verdana" ForeColor="Gray">
                <asp:TableRow>
                    <asp:TableCell wrap="False" HorizontalAlign="Center">
                        <br />
                        <br />
                        <asp:Label ID="Label16" runat="server" forecolor="Gray" font-size="X-Small" font-names="Verdana" font-bold="True">You have changed the default permissions for this user (or no user permissions were previously defined).<br /><br />Click continue to apply the new permissions, or cancel to retain any existing permissions.</asp:Label>
                        <br />
                        <br />
                        <br />
                        <br />
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td align="left" style="width: 29%" valign="top">
                        ...
                        <br />
                        &nbsp; &nbsp; <asp:Button ID="btnRemoveUserGroup" runat="server" Text="remove user group" Width="200px" OnClick="btnRemoveUserGroup_Click" OnClientClick='return confirm("Are you sure you want to remove this user group? User accounts will NOT be removed. No user must be referencing the group to be deleted.");' Enabled="False" />
                    </td>
                    <td style="width: 1%">
                    </td>
                </tr>
        ...
        <asp:Panel ID="pnlRenameUserGroup" runat="server" Width="100%" Visible="False">
            <table style="width: 100%">
                <tr>
                    ...
                    <td align="right" style="width: 29%">
                        <asp:Button ID="btnBackFromRenameUserGroup" runat="server" Text="back" OnClick="btnBackFromRenameUserGroup_Click" /></td>
                    <td style="width: 1%">
                    </td>
                </tr>
                <tr>
    ...
    <script language="JavaScript" type="text/javascript" src="wz_tooltip.js"></script> <!-- usage: onmouseover="return escape('Tooltip text')" -->
