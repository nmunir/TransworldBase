<%@ Page Language="VB" MasterPageFile="~/WebForm.master" StylesheetTheme="Basic" %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal Source As Object, ByVal E As EventArgs)
        ...
        Dim sForceSiteKey As String
        If Not pbWebformIsInitialised Then              ' is nothing on first load as panel has not yet been loaded to init SiteKey
            Session.Clear()
            Try
                sForceSiteKey = ConfigurationManager.AppSettings.Item("ForceSiteKey")
            Catch
                sForceSiteKey = String.Empty
            End Try
            If IsNumeric(sForceSiteKey) Then
                Session("SiteKey") = sForceSiteKey
            Else
                Call GetSiteKeyFromSiteName(sGetPath)
            End If
            If Not IsNumeric(Session("SiteKey")) Then
            ...
            <td class="bodyText" style="width: 856px">
                ...
                <asp:Panel ID="pnlAddress" runat="server" Width="100%">
                    ...
                    <table width="90%">
                        ...
                        <tr runat="server" id="trCostCentre" visible="false">
                            <td>
