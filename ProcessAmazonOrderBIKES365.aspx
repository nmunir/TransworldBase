...
<script runat="server">
    ...
    Private Sub CreateAmazonFolder()
        ...
        If Not Directory.Exists(sPath & "\AmazonBIKES365") Then
            Directory.CreateDirectory(sPath & "\AmazonBIKES365")
        End If
    End Sub
    
    Private Sub ReadCookies()
        Dim addressCookie As HttpCookie = Request.Cookies("AddressInfoBIKES365")
        ...
        Else
            txtCustomerName.Text = "Amazon.co.uk"
            txtAddr1.Text = "Unit 1"
            txtAddr2.Text = "Balby Carr Bank"
            txtAddr3.Text = "Balby"
            txtTown.Text = "Doncaster"
            txtPostCode.Text = "DN4 5JS"
    ...
    Private Sub SaveCookie()
        Dim addressCookie As New HttpCookie("AddressInfoBIKES365")
    ...
    Protected Function BuildProductsTable(ByVal dtSpreadsheet As DataTable) As DataTable
        Const COL_CATALOGUE_NUMBER As Int32 = 2
        Const COL_QUANTITYORDERED As Int32 = 8
    ...
    Private Function GetProductKey(ByVal sProductCode As String) As Integer
        Dim sSQL As String = "SELECT LogisticProductKey FROM LogisticProduct WHERE ProductCode = '" & sProductCode & "' AND CustomerKey = " & Session("CustomerKey")
    ...
    Protected Function nSubmitConsignment(ByRef dt As DataTable, ByVal nStart As Int32, ByVal nEnd As Int32) As Integer
        ...
        Dim sSQL As String = "SELECT * FROM Customer WHERE CustomerKey = " & Session("CustomerKey")
    ...
    Public Function ExcelSheetToDataTable() As System.Data.DataTable
        ...
        Dim sFilePath As String = Server.MapPath("~/AmazonBIKES365/" & psFileName)
        ...
        If File.Exists(sFilePath) Then
            ...
            For i As Integer = 1 To col
                ...
                ElseIf column.Value.ToString() = "CATALOG_NUMBER" Or column.Value.ToString() = "ABIS_STOCK" Then
...
<body>
    ...
    <div>
        ...
        <telerik:RadUpload ID="ruAmazonFileUpload" Width="100%" TargetFolder="~/AmazonBIKES365" AllowedFileExtensions=".xlsx"
