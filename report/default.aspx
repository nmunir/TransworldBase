...
<script runat="server">
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            If CInt(tbDays.Text) > (366 * 2) Then
                WebMsgBox.Show("Maximum two years")
            Else
                Call GenerateData()
            End If
        End If
    ...
    Protected Sub GenerateData()
        ...
        Dim sSQL As String = "SELECT id 'Record #', Title, Name, Company, JobTitle 'Job Title', Address, Postcode, Email, Telephone, Comments, TypeOfOrganisation 'Type of Organisation', ISNULL(RegisteredCharityNo,'') 'Reg. Charity No', Optin 'Opt In', ConsignmentKey 'Consignment No.', ISNULL(CashOnDelAmount,0.00) 'Consignment Cost', EntryTimestamp 'Order Placed', PurchaseOrderNo 'Purchase Order No.', Mode 'User Type' FROM ClientData_DrinkAware LEFT OUTER JOIN Consignment ON ClientData_DrinkAware.ConsignmentKey = Consignment.[key] WHERE EntryTimestamp >= '" & dtStart.ToString("dd-MMM-yyyy") & "' ORDER BY EntryTimestamp"
