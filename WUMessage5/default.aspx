...
<body>
    ...
    <div data-role="page" id="pg_Agent">
        ...
        <div data-role="content">
            <div class="divParent" data-role="content">
                <div class="divleft">
                    <label for="selectTopicCategory">
                        Choose topic category:</label></div>
                <div class="divright">
                    <select id="selectTopicCategory" data-theme="b">
                    </select>
                </div>
            </div>
            <div class="divParent" data-role="fieldcontain">
                <div class="divleft">
                    User ID :</div>
                <div class="divright">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="divParent" id="divTseUserID">
                <div class="divleft">
                    TSE User ID :</div>
                <div class="divright">
            ...
            <div class="divParent">
                ...
                <div class="divright">
                    <select id="sliderRemember" data-role="slider">
