...
<script runat="server">
    ...
    Protected Function ProductExists(ByVal sProductCode As String, ByVal sProductDate As String) As Boolean
        Dim sSQL As String = "SELECT ProductCode FROM LogisticProduct WHERE CustomerKey = " & gnCustomerKey & " AND ProductCode = '" & sProductCode.Replace("'", "''") & "' AND ISNULL(ProductDate,'') = '" & sProductDate.Replace("'", "''") & "'"
        ...
        Else
            ProductExists = True
            Call Log(LOG_ENTRY_TYPE_PRODUCT, -1, -1, sProductDate, sMessage & "YES")
        End If
    End Function
