                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Font-Size="XX-Small" 
                            ...
                            Text="3. Check that the address in your browser begins &lt;b&gt;https:&lt;/b&gt;. You may also see a padlock icon on the status bar at the bottom of the browser window. This indicates you are using a secure, encrypted transfer protocol."></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label5" runat="server" Font-Names="Verdana" Font-Size="XX-Small" 
                            
                            Text="4. Click the &lt;b&gt;upload&lt;/b&gt; button. On completion of the upload you will see a message 'File uploaded successfully' and a list of the email recipients to whom an upload alert has been sent, if any are defined."></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="Label6" runat="server" Font-Names="Verdana" Font-Size="XX-Small" 
                            Text="5. You can view the upload history by clicking the &lt;b&gt;show upload history&lt;/b&gt; link at the top of this window."></asp:Label>
                        <br />
                    </td>
                    <td>
                        &nbsp;</td>
